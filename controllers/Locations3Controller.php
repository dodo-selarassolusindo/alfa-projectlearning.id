...
class Locations3Controller extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/locations3list[/{ID}]", [PermissionMiddleware::class], "list.locations3")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "Locations3List");
    }
}
