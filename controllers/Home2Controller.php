 ...
 * home2 controller
 */
class Home2Controller extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/home2[/{params:.*}]", [PermissionMiddleware::class], "custom.home2")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "Home2");
    }
}
