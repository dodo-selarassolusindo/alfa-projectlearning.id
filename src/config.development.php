...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "password" => "", "dbname" => "demo2024"],
        "demo2" => ["id" => "demo2", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "password" => "", "dbname" => "demo2"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "VUYr/N6HVhYLTxMcWjkpBTRVDurFkw4YD1v79Yqq4o4=", // JWT secret key
