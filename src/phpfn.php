...
Type::addType("geometry", "PHPMaker2024\\demo2024\\GeometryType"); // "geometry" type
Type::addType("geography", "PHPMaker2024\\demo2024\\GeographyType"); // "geography" type
Type::addType("hierarchyid", "PHPMaker2024\\demo2024\\HierarchyIdType"); // "hierarchyid" type
Type::addType("bytes", "PHPMaker2024\\demo2024\\BytesType"); // "bytes" type
...
{
    $criteria = array_merge(["username" => $username], $criteria);
...
function TwoFactorAuthenticationClass()
{
    return match (Config("TWO_FACTOR_AUTHENTICATION_TYPE")) {
        ...
        "google" => PragmaRxTwoFactorAuthentication::class,
        default => Config("TWO_FACTOR_AUTHENTICATION_CLASS"),
    };
}
