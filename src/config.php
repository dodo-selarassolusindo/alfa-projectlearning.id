...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/prj_alfa.css", // Project stylesheet file name
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\prj_alfa\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\prj_alfa\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-b699ec9a-9493-4587-8132-9ccdcdb555dd", // Export folder
