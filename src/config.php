...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/demo2024.css", // Project stylesheet file name
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-lightblue", // CSS class(es) for sidebar
    ...
    "AES_ENCRYPTION_KEY" => "VUYr/N6HVhYLTxMcWjkpBTRVDurFkw4YD1v79Yqq4o4=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\demo2024\\Saml2',
    ...
    "SESSION_TIMEOUT" => 20, // Session timeout time (minutes)
    ...
    "ADMIN_USER_NAME" => "owner", // Administrator user name
    "ADMIN_PASSWORD" => "Duaribu21`", // Administrator password
    ...
    "USER_TABLE_NAME" => "employees",
    "USER_TABLE_ENTITY_CLASS" => Entity\Employee::class,
    ...
    // Email
    "SENDER_EMAIL" => "admin@mycompany.com", // Sender email address
    "RECIPIENT_EMAIL" => "admin@mycompany.com", // Recipient email address
    ...
    "UPLOAD_ALLOWED_FILE_EXT" => "gif,jpg,jpeg,bmp,png,doc,xls,pdf,zip,csv,xlsx", // Allowed file extensions
    "IMAGE_ALLOWED_FILE_EXT" => "gif,jpg,png,bmp", // Allowed file extensions for images
