...
<html lang="en">
    ...
    <body class="layout-fluid">
            ...
            <header class="navbar navbar-expand-md d-print-none" >
                <div class="container-xl">
                    ...
                    <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                        <a href="<?= site_url() ?>">
                            <img src="<?= base_url() ?>assets/tabler/static/logo.png" width="110" height="32" alt="Tabler" class="navbar-brand-image">
                        </a>
                    </h1>
                    <!-- /top-left menu -->
                    ...
                    <div class="navbar-nav flex-row order-md-last">
                        ...
                        <div class="nav-item dropdown">
                            <!-- <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                                <span class="avatar avatar-sm" style="background-image: url(<?= base_url() ?>assets/tabler/static/avatars/000m.jpg)"></span>
        ...
        <!-- Libs JS -->
        <script src="<?= base_url() ?>assets/tabler/libs/apexcharts/dist/apexcharts.min.js?1684106062" defer></script>
        <script src="<?= base_url() ?>assets/tabler/libs/jsvectormap/dist/js/jsvectormap.min.js?1684106062" defer></script>
        <script src="<?= base_url() ?>assets/tabler/libs/jsvectormap/dist/maps/world.js?1684106062" defer></script>
        <script src="<?= base_url() ?>assets/tabler/libs/jsvectormap/dist/maps/world-merc.js?1684106062" defer></script>
        <!-- Tabler Core -->
