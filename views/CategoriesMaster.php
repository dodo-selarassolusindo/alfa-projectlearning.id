...
$categories->TableClass = "table table-bordered table-hover table-sm ew-table ew-master-table";
?>
<?php if ($categories->Visible) { ?>
<div id="t_categories" class="card ew-grid ew-list-form ew-master-div <?= $categories->TableContainerClass ?>">
<table id="tbl_categoriesmaster" class="<?= $categories->TableClass ?>">
    <thead>
