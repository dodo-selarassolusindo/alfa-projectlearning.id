...
var currentForm;
var fcustomerssearch, currentSearchForm, currentAdvancedSearchForm;
...
$Page->showMessage();
?>
<form name="fcustomerssearch" id="fcustomerssearch" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->CustomerID->Visible) { // CustomerID ?>
    <div id="r_CustomerID" class="row"<?= $Page->CustomerID->rowAttributes() ?>>
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_customers_CustomerID"><?= $Page->CustomerID->caption() ?></span>
...
<input type="hidden" name="z_CustomerID" id="z_CustomerID" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->CustomerID->cellAttributes() ?>>
                ...
                <span id="el_customers_CustomerID" class="ew-search-field ew-search-field-single">
<?php
if (IsRTL()) {
...
<script>
loadjs.ready("fcustomerssearch", function() {
    fcustomerssearch.createAutoSuggest(Object.assign({"id":"x_CustomerID","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->CustomerID->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.customers.fields.CustomerID.autoSuggestOptions));
});
</script>
...
<?php if ($Page->CompanyName->Visible) { // CompanyName ?>
    <div id="r_CompanyName" class="row"<?= $Page->CompanyName->rowAttributes() ?>>
        <label for="x_CompanyName" class="<?= $Page->LeftColumnClass ?>"><span id="elh_customers_CompanyName"><?= $Page->CompanyName->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_CompanyName" id="z_CompanyName" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->CompanyName->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_customers_CompanyName" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->ContactName->Visible) { // ContactName ?>
    <div id="r_ContactName" class="row"<?= $Page->ContactName->rowAttributes() ?>>
        <label for="x_ContactName" class="<?= $Page->LeftColumnClass ?>"><span id="elh_customers_ContactName"><?= $Page->ContactName->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_ContactName" id="z_ContactName" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->ContactName->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_customers_ContactName" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->ContactTitle->Visible) { // ContactTitle ?>
    <div id="r_ContactTitle" class="row"<?= $Page->ContactTitle->rowAttributes() ?>>
        <label for="x_ContactTitle" class="<?= $Page->LeftColumnClass ?>"><span id="elh_customers_ContactTitle"><?= $Page->ContactTitle->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_ContactTitle" id="z_ContactTitle" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->ContactTitle->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_customers_ContactTitle" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->Address->Visible) { // Address ?>
    <div id="r_Address" class="row"<?= $Page->Address->rowAttributes() ?>>
        <label for="x_Address" class="<?= $Page->LeftColumnClass ?>"><span id="elh_customers_Address"><?= $Page->Address->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_Address" id="z_Address" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->Address->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_customers_Address" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->Address->getInputTextType() ?>" name="x_Address" id="x_Address" data-table="customers" data-field="x_Address" value="<?= $Page->Address->EditValue ?>" size="30" maxlength="60" placeholder="<?= HtmlEncode($Page->Address->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Address->formatPattern()) ?>"<?= $Page->Address->editAttributes() ?>>
...
<?php if ($Page->City->Visible) { // City ?>
    <div id="r_City" class="row"<?= $Page->City->rowAttributes() ?>>
        <label for="x_City" class="<?= $Page->LeftColumnClass ?>"><span id="elh_customers_City"><?= $Page->City->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_City" id="z_City" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->City->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_customers_City" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->City->getInputTextType() ?>" name="x_City" id="x_City" data-table="customers" data-field="x_City" value="<?= $Page->City->EditValue ?>" size="30" maxlength="15" placeholder="<?= HtmlEncode($Page->City->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->City->formatPattern()) ?>"<?= $Page->City->editAttributes() ?>>
...
<?php if ($Page->Region->Visible) { // Region ?>
    <div id="r_Region" class="row"<?= $Page->Region->rowAttributes() ?>>
        <label for="x_Region" class="<?= $Page->LeftColumnClass ?>"><span id="elh_customers_Region"><?= $Page->Region->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_Region" id="z_Region" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->Region->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_customers_Region" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->Region->getInputTextType() ?>" name="x_Region" id="x_Region" data-table="customers" data-field="x_Region" value="<?= $Page->Region->EditValue ?>" size="30" maxlength="15" placeholder="<?= HtmlEncode($Page->Region->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Region->formatPattern()) ?>"<?= $Page->Region->editAttributes() ?>>
...
<?php if ($Page->PostalCode->Visible) { // PostalCode ?>
    <div id="r_PostalCode" class="row"<?= $Page->PostalCode->rowAttributes() ?>>
        <label for="x_PostalCode" class="<?= $Page->LeftColumnClass ?>"><span id="elh_customers_PostalCode"><?= $Page->PostalCode->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_PostalCode" id="z_PostalCode" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->PostalCode->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_customers_PostalCode" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->Country->Visible) { // Country ?>
    <div id="r_Country" class="row"<?= $Page->Country->rowAttributes() ?>>
        <label for="x_Country" class="<?= $Page->LeftColumnClass ?>"><span id="elh_customers_Country"><?= $Page->Country->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_Country" id="z_Country" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->Country->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_customers_Country" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->Country->getInputTextType() ?>" name="x_Country" id="x_Country" data-table="customers" data-field="x_Country" value="<?= $Page->Country->EditValue ?>" size="30" maxlength="15" placeholder="<?= HtmlEncode($Page->Country->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Country->formatPattern()) ?>"<?= $Page->Country->editAttributes() ?>>
...
<?php if ($Page->Phone->Visible) { // Phone ?>
    <div id="r_Phone" class="row"<?= $Page->Phone->rowAttributes() ?>>
        <label for="x_Phone" class="<?= $Page->LeftColumnClass ?>"><span id="elh_customers_Phone"><?= $Page->Phone->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_Phone" id="z_Phone" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->Phone->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_customers_Phone" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->Phone->getInputTextType() ?>" name="x_Phone" id="x_Phone" data-table="customers" data-field="x_Phone" value="<?= $Page->Phone->EditValue ?>" size="30" maxlength="24" placeholder="<?= HtmlEncode($Page->Phone->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Phone->formatPattern()) ?>"<?= $Page->Phone->editAttributes() ?>>
...
<?php if ($Page->Fax->Visible) { // Fax ?>
    <div id="r_Fax" class="row"<?= $Page->Fax->rowAttributes() ?>>
        <label for="x_Fax" class="<?= $Page->LeftColumnClass ?>"><span id="elh_customers_Fax"><?= $Page->Fax->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_Fax" id="z_Fax" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->Fax->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_customers_Fax" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->Fax->getInputTextType() ?>" name="x_Fax" id="x_Fax" data-table="customers" data-field="x_Fax" value="<?= $Page->Fax->EditValue ?>" size="30" maxlength="24" placeholder="<?= HtmlEncode($Page->Fax->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Fax->formatPattern()) ?>"<?= $Page->Fax->editAttributes() ?>>
...
<?= $Page->IsModal ? '<template class="ew-modal-buttons">' : '<div class="row ew-buttons">' ?><!-- buttons .row -->
    <div class="<?= $Page->OffsetColumnClass ?>"><!-- buttons offset -->
        <button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fcustomerssearch"><?= $Language->phrase("Search") ?></button>
        <?php if ($Page->IsModal) { ?>
        <button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fcustomerssearch"><?= $Language->phrase("Cancel") ?></button>
        <?php } else { ?>
        <button class="btn btn-default ew-btn" name="btn-reset" id="btn-reset" type="button" form="fcustomerssearch" data-ew-action="reload"><?= $Language->phrase("Reset") ?></button>
        <?php } ?>
    </div><!-- /buttons offset -->
