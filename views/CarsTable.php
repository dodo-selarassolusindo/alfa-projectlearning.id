...
<form name="<?= $Page->FormName ?>" id="<?= $Page->FormName ?>" class="ew-form ew-list-form ew-multi-column-form" action="<?= $Page->PageAction ?>" method="post" novalidate autocomplete="off">
