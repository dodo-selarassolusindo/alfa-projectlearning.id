...
<?php if ($Page->ProductName2->Visible) { ?>
    ...
    <th data-name="ProductName2"<?= $Page->ProductName2->cellAttributes("ew-rpt-grp-caret") ?>><?= $Page->ProductName2->groupToggleIcon() ?></th>
    <?php } else { ?>
...
<?php if ($Page->ProductName2->Visible) { ?>
        <td data-field="ProductName2"<?= $Page->ProductName2->cellAttributes("ew-rpt-grp-caret") ?>><?= $Page->ProductName2->groupToggleIcon() ?></td>
<?php } ?>
...
<?php if ($Page->TotalGroups > 0) { ?>
<?php
    $Page->UnitsInStock->getSum($Page->ProductName2->Records, false); // Get Sum
    $Page->resetAttributes();
    $Page->RowType = RowType::TOTAL;
    $Page->RowTotalType = RowSummary::GROUP;
