...
<?php } ?>
<?php if (!$Page->IsModal) { ?>
<form name="forder_details_extendedsrch" id="forder_details_extendedsrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>" novalidate autocomplete="off">
