...
<?php if ($Page->Year->Visible) { ?>
    ...
    <th data-name="Year"<?= $Page->Year->cellAttributes("ew-rpt-grp-caret") ?>><?= $Page->Year->groupToggleIcon() ?></th>
    <?php } else { ?>
...
<?php if ($Page->Year->Visible) { ?>
        <td data-field="Year"<?= $Page->Year->cellAttributes("ew-rpt-grp-caret") ?>><?= $Page->Year->groupToggleIcon() ?></td>
<?php } ?>
...
<?php } ?>
<?php if ($Page->ShippedDate->Visible) { ?>
        <td data-field="ShippedDate"<?= $Page->ShippedDate->cellAttributes("ew-rpt-grp-caret") ?>><?= $Page->ShippedDate->groupToggleIcon() ?></td>
<?php } ?>
...
<?php if ($Page->TotalGroups > 0) { ?>
<?php
    $Page->Subtotal->getSum($Page->ShippedDate->Records, false); // Get Sum
    $Page->resetAttributes();
    $Page->RowType = RowType::TOTAL;
    $Page->RowTotalType = RowSummary::GROUP;
...
<?php if ($Page->TotalGroups > 0) { ?>
<?php
    $Page->Subtotal->getSum($Page->Year->Records, false); // Get Sum
    $Page->resetAttributes();
    $Page->RowType = RowType::TOTAL;
    $Page->RowTotalType = RowSummary::GROUP;
    $Page->RowTotalSubType = RowTotal::FOOTER;
