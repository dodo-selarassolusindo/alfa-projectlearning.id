...
<?php } ?>
<?php } ?>
<form name="fcalendarview" id="fcalendarview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
