...
$Page->showMessage();
?>
<form name="ftrademarksadd" id="ftrademarksadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php
    if (in_array("models", explode(",", $Page->getCurrentDetailTable())) && $models->DetailAdd) {
?>
