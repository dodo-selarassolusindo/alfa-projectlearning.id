...
if (!calendarLoaded) {
    ew.loadjs([
        ew.PATH_BASE + "fullcalendar/index.global.js?v=24.7.4",
        ew.PATH_BASE + "fullcalendar/bootstrap5/index.global.js?v=24.7.4"
    ], "fullcalendar");
    ew.ready(["fullcalendar", "luxon"], ew.PATH_BASE + "fullcalendar/luxon3/index.global.js?v=24.7.4");
}
loadjs.ready(
