...
if (!calendarLoaded) {
    ew.loadjs([
        ew.PATH_BASE + "fullcalendar/index.global.min.js?v=24.7.6",
        ew.PATH_BASE + "fullcalendar/bootstrap5/index.global.min.js?v=24.7.6"
    ], "fullcalendar");
    ew.ready(["fullcalendar", "luxon"], ew.PATH_BASE + "fullcalendar/luxon3/index.global.min.js?v=24.7.6");
}
loadjs.ready(
