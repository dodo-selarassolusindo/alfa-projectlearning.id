...
$orders->TableClass = "table table-bordered table-hover table-sm ew-table ew-master-table";
?>
<?php if ($orders->Visible) { ?>
<div id="t_orders" class="card ew-grid ew-list-form ew-master-div <?= $orders->TableContainerClass ?>">
<table id="tbl_ordersmaster" class="<?= $orders->TableClass ?>">
    <thead>
