...
<?= $Page->Pager->render() ?>
<?php } ?>
<form name="ftrademarksedit" id="ftrademarksedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
...
<?php
    if (in_array("models", explode(",", $Page->getCurrentDetailTable())) && $models->DetailEdit) {
?>
