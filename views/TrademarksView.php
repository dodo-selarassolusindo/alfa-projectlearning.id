...
<?php } ?>
<?php } ?>
<form name="ftrademarksview" id="ftrademarksview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php
    if (in_array("models", explode(",", $Page->getCurrentDetailTable())) && $models->DetailView) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
<h4 class="ew-detail-caption"><?= $Language->tablePhrase("models", "TblCaption") ?></h4>
<?php } ?>
<?php include_once "ModelsGrid.php" ?>
<?php } ?>
</form>
<?php if (!$Page->IsModal) { ?>
<?php if (!$Page->isExport()) { ?>
