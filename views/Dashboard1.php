...
<template id="tpx_Dashboard1_CategoryName" class="Sales_By_Customer_2summary"><span id="el_Dashboard1_CategoryName" class="ew-search-field ew-search-field-single">
    <select
        id="x_CategoryName"
        name="x_CategoryName"
