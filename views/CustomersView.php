...
<h4 class="ew-detail-caption"><?= $Language->tablePhrase("orders", "TblCaption") ?>&nbsp;<?= str_replace("%s", "blue", str_replace("%c", Container("orders")->Count, $Language->phrase("DetailCount"))) ?></h4>
<?php } ?>
