...
<?php } ?>
<?php if (!$Page->IsModal) { ?>
<form name="fproductssrch" id="fproductssrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>" novalidate autocomplete="off">
...
<i class="fa-regular fa-square<?php if (ConvertToBool($Page->Discontinued->CurrentValue)) { ?>-check<?php } ?> ew-icon ew-boolean"></i>
</span>
</span>
</td>
    <?php } ?>
