...
<script src="<?= $basePath ?>js/ewcore.js?v=24.7.6"></script>
<script>
var $rowindex$ = null;
Object.assign(ew, <?= JsonEncode(ConfigClientVars()) ?>, <?= JsonEncode(GlobalClientVars()) ?>);
loadjs(ew.PATH_BASE + "jquery/jquery.js?v=24.7.6", "jquery");
loadjs(ew.PATH_BASE + "js/popper.js?v=24.7.6", "popper");
loadjs(ew.PATH_BASE + "js/luxon.js?v=24.7.6", "luxon");
loadjs([
    ew.PATH_BASE + "js/mobile-detect.js?v=24.7.6",
    ew.PATH_BASE + "js/purify.js?v=24.7.6",
    ew.PATH_BASE + "js/cropper.js?v=24.7.6",
    ew.PATH_BASE + "jquery/load-image.all.js?v=24.7.6"
], "others");
loadjs(ew.PATH_BASE + "js/sweetalert2.all.js?v=24.7.6", "swal");
<?= $Language->toJson() ?>
ew.vars = <?= JsonEncode(GetClientVar()) ?>;
ew.ready(["wrapper", "jquery"], ew.PATH_BASE + "jquery/jsrender.js?v=24.7.6", "jsrender", ew.renderJsTemplates);
ew.ready("jquery", ew.PATH_BASE + "jquery/jquery-ui.js?v=24.7.6", "widget");
</script>
...
<?php } ?>
cssjs.push(ew.PATH_BASE + "jquery/query-builder.js?v=24.7.6");
cssjs.push(ew.PATH_BASE + "css/<?= CssFile("query-builder.css") ?>?v=24.7.6");
var jqueryjs = [
    ew.PATH_BASE + "jquery/select2.full.js?v=24.7.6",
    ew.PATH_BASE + "jquery/jqueryfileupload.js?v=24.7.6",
    ew.PATH_BASE + "jquery/typeahead.jquery.js?v=24.7.6"
];
jqueryjs.push(ew.PATH_BASE + "jquery/pStrength.jquery.js?v=24.7.6");
jqueryjs.push(ew.PATH_BASE + "jquery/pGenerator.jquery.js?v=24.7.6");
jqueryjs.push(ew.PATH_BASE + "colorbox/jquery.colorbox.js?v=24.7.6");
jqueryjs.push(ew.PATH_BASE + "js/pdfobject.js?v=24.7.6");
ew.ready(["jquery", "dom", "popper"], ew.PATH_BASE + "bootstrap5/js/bootstrap.js?v=24.7.6", "bootstrap"); // Bootstrap
ew.ready("popper", ew.PATH_BASE + "js/tippy-bundle.umd.js?v=24.7.6", "tippy"); // Tippy
ew.ready("bootstrap", ew.PATH_BASE + "adminlte3/js/adminlte.js?v=24.7.6", "adminlte"); // AdminLTE (After Bootstrap)
ew.ready(["jquery", "widget"], [jqueryjs], "jqueryjs");
ew.ready(["bootstrap", "adminlte", "jqueryjs", "luxon", "others"], ew.PATH_BASE + "js/ew.js?v=24.7.6", "makerjs");
ew.ready("makerjs", [
    cssjs,
