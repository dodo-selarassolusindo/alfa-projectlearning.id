...
<link rel="stylesheet" href="<?= $basePath ?>css/select2.min.css?v=24.7.4">
<link rel="stylesheet" href="<?= $basePath ?>css/select2-bootstrap5.min.css?v=24.7.4">
<link rel="stylesheet" href="<?= $basePath ?><?= Config("FONT_AWESOME_STYLESHEET") ?>?v=24.7.4">
...
<script>
var cssfiles = [
    ew.PATH_BASE + "css/jquery.fileupload.css?v=24.7.4",
    ew.PATH_BASE + "css/jquery.fileupload-ui.css?v=24.7.4",
    ew.PATH_BASE + "css/cropper.min.css?v=24.7.4"
];
cssfiles.push(ew.PATH_BASE + "colorbox/colorbox.css?v=24.7.4");
loadjs(cssfiles, "css");
var cssjs = [];
...
ew.ready("makerjs", [
    ...
    ew.PATH_BASE + "js/userevent.js?v=24.7.4"
], "head");
</script>
<script>
