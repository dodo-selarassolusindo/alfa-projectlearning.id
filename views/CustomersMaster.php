...
$customers->TableClass = "table table-bordered table-hover table-sm ew-table ew-master-table";
?>
<?php if ($customers->Visible) { ?>
<div id="t_customers" class="card ew-grid ew-list-form ew-master-div <?= $customers->TableContainerClass ?>">
<table id="tbl_customersmaster" class="<?= $customers->TableClass ?>">
    <thead>
