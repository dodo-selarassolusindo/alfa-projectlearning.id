...
/**
 * Table class for Alphabetical List of Products
 */
class AlphabeticalListOfProducts extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->ReportSourceTable = 'list_of_products'; // Report source table
        $this->Dbid = 'DB';
        ...
        $this->ProductName->SourceTableVar = 'list_of_products';
        ...
        $this->CategoryName->SourceTableVar = 'list_of_products';
        ...
        $this->QuantityPerUnit->SourceTableVar = 'list_of_products';
        ...
        $this->UnitsInStock->SourceTableVar = 'list_of_products';
        $this->Fields['UnitsInStock'] = &$this->UnitsInStock;

        // ProductName2
        $this->ProductName2 = new ReportField(
            $this, // Table
        ...
        $this->ProductName2->GroupingFieldId = 1;
        $this->ProductName2->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->ProductName2->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->ProductName2->GroupByType = "f";
        $this->ProductName2->GroupInterval = "1";
        $this->ProductName2->GroupSql = "SUBSTRING(%s,1,1)";
        $this->ProductName2->Nullable = false; // NOT NULL field
        $this->ProductName2->Required = true; // Required field
        $this->ProductName2->LookupExpression = "SUBSTRING(`ProductName2`,1,1)";
        $this->ProductName2->SearchOperators = ["="];
        $this->ProductName2->SourceTableVar = 'list_of_products';
    ...
    public function getSqlFirstGroupField($alias = false)
    {
        ...
        $firstGroupField = &$this->ProductName2;
    ...
    {
        return $this->sqlSelectAggregate ?? $this->getQueryBuilder()->select("SUM(`UnitsInStock`) AS sum_unitsinstock");
    }
    ...
    {
        return "alphabeticallistofproducts";
    }

    // API page name
    public function getApiPageName($action)
    {
        return "AlphabeticalListOfProductsSummary";
    }
