 ...
 * Page class
 */
class ModelsGrid extends Models
{
    use MessagesTrait;
    ...
    public $FormName = "fmodelsgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "modelsgrid";
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->Trademark->getSessionValue() != "") {
                $this->Trademark->CurrentValue = GetForeignKeyValue($this->Trademark->getSessionValue());
    ...
    protected function editRow()
    {
        ...
        // Check field with unique index (Model)
        if ($this->Model->CurrentValue != "") {
            $filterChk = "(`Model` = '" . AdjustSql($this->Model->CurrentValue, $this->Dbid) . "')";
            ...
            if ($rsChk->fetch()) {
                $idxErrMsg = str_replace("%f", $this->Model->caption(), $Language->phrase("DupIndex"));
                $idxErrMsg = str_replace("%v", $this->Model->CurrentValue, $idxErrMsg);
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['Trademark'])) { // Trademark
            $this->Trademark->CurrentValue = $row['Trademark'];
        }
        if (isset($row['Model'])) { // Model
            $this->Model->CurrentValue = $row['Model'];
        }
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "trademarks") {
            $this->Trademark->Visible = true; // Need to insert foreign key
            $this->Trademark->CurrentValue = $this->Trademark->getSessionValue();
        }
        ...
        // Update current values
        $this->setCurrentValues($rsnew);
        if ($this->Model->CurrentValue != "") { // Check field with unique index
            $filter = "(`Model` = '" . AdjustSql($this->Model->CurrentValue, $this->Dbid) . "')";
