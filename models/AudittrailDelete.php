 ...
 * Page class
 */
class AudittrailDelete extends Audittrail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AudittrailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("audittraillist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("audittraillist"); // Return to list
                return;
            }
        }
