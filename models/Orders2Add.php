 ...
 * Page class
 */
class Orders2Add extends Orders2
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "orders2add";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "orders2view") {
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['ShipRegion'])) { // ShipRegion
            $this->ShipRegion->setFormValue($row['ShipRegion']);
        }
        if (isset($row['ShipPostalCode'])) { // ShipPostalCode
            $this->ShipPostalCode->setFormValue($row['ShipPostalCode']);
        }
