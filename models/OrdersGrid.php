...
class OrdersGrid extends Orders
{
    ...
    {
        $this->EmployeeID->DefaultValue = CurrentUserID();
        $this->EmployeeID->OldValue = $this->EmployeeID->DefaultValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "customers") {
            $this->CustomerID->Visible = true; // Need to insert foreign key
