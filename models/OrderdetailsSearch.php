        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->ProductID->AdvancedSearch->ViewValue !== null) { // Load from cache
                ...
                if ($curVal == "") {
                    ...
                    $filterWrk = SearchFilter($this->ProductID->Lookup->getTable()->Fields["ProductID"]->searchExpression(), "=", $this->ProductID->AdvancedSearch->SearchValue, $this->ProductID->Lookup->getTable()->Fields["ProductID"]->searchDataType(), "");
                }
            ...
            $this->Discount->EditValue = $this->Discount->AdvancedSearch->SearchValue;
            $this->Discount->PlaceHolder = RemoveHtml($this->Discount->caption());

            // SubTotal
            $this->SubTotal->setupEditAttributes();
            $this->SubTotal->EditValue = $this->SubTotal->AdvancedSearch->SearchValue;
