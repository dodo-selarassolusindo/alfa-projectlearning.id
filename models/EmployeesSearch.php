        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->ReportsTo->AdvancedSearch->ViewValue !== null) { // Load from cache
                ...
                if ($curVal == "") {
                    ...
                    $filterWrk = SearchFilter($this->ReportsTo->Lookup->getTable()->Fields["EmployeeID"]->searchExpression(), "=", $this->ReportsTo->AdvancedSearch->SearchValue, $this->ReportsTo->Lookup->getTable()->Fields["EmployeeID"]->searchDataType(), "");
                }
            ...
            if (!$Security->canAdmin()) { // System admin
                ...
                if ($this->_UserLevel->AdvancedSearch->ViewValue !== null) { // Load from cache
                    ...
                    if ($curVal == "") {
                        ...
                        $filterWrk = SearchFilter($this->_UserLevel->Lookup->getTable()->Fields["userlevelid"]->searchExpression(), "=", $this->_UserLevel->AdvancedSearch->SearchValue, $this->_UserLevel->Lookup->getTable()->Fields["userlevelid"]->searchDataType(), "");
                    }
