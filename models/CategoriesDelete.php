 ...
 * Page class
 */
class CategoriesDelete extends Categories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CategoriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "categoriesdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("categorieslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("categorieslist"); // Return to list
                return;
            }
        }
