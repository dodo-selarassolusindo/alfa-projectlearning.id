 ...
 * Page class
 */
class OrderdetailsView extends Orderdetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OrderdetailsView";
    ...
    // CSS class/style
    public $CurrentPageName = "orderdetailsview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("ProductID") ?? Route("ProductID")) !== null) {
            $this->RecKey["ProductID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("OrderID") ?? Route("OrderID")) !== null) {
            ...
            $returnUrl = "orderdetailslist"; // Return to list
        }
        if (($keyValue = Get("ProductID") ?? Route("ProductID")) !== null) {
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("orderdetailslist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->OrderID->CurrentValue, $this->CurrentRow['OrderID']) && SameString($this->ProductID->CurrentValue, $this->CurrentRow['ProductID'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "orderdetailslist"; // No matching record, return to list
                    } else {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="forderdetailsview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
