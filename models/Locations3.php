...
/**
 * Table class for locations3
 */
class Locations3 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->Latitude->addMethod("getDefault", fn() => 0);
        ...
        $this->Longitude->addMethod("getDefault", fn() => 0);
        ...
        // Coordinate
        $this->Coordinate = new DbField(
            $this, // Table
            'x_Coordinate', // Variable name
            'Coordinate', // Name
            '`Coordinate`', // Expression
            '`Coordinate`', // Basic search expression
            200, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Coordinate`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Coordinate->InputTextType = "text";
        $this->Coordinate->Raw = true;
        $this->Coordinate->CustomDataType = new GeometryType();
        $this->Coordinate->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['Coordinate'] = &$this->Coordinate;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "locations";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->Coordinate->DbValue = $row['Coordinate'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("locations3list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "locations3view" => $Language->phrase("View"),
            "locations3edit" => $Language->phrase("Edit"),
            "locations3add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "Locations3View",
            Config("API_ADD_ACTION") => "Locations3Add",
            Config("API_EDIT_ACTION") => "Locations3Edit",
            Config("API_DELETE_ACTION") => "Locations3Delete",
            Config("API_LIST_ACTION") => "Locations3List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("locations3view", $parm);
        } else {
            $url = $this->keyUrl("locations3view", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("locations3edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("locations3list", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("locations3add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("locations3list", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("locations3delete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        // Coordinate
        $this->Coordinate->setupEditAttributes();
        if (!$this->Coordinate->Raw) {
            $this->Coordinate->CurrentValue = HtmlDecode($this->Coordinate->CurrentValue);
        }
        $this->Coordinate->EditValue = $this->Coordinate->CurrentValue;
        $this->Coordinate->PlaceHolder = RemoveHtml($this->Coordinate->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->Coordinate);
                } else {
                    $doc->exportCaption($this->ID);
                    $doc->exportCaption($this->Latitude);
                    $doc->exportCaption($this->Longitude);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->Coordinate);
                    } else {
                        $doc->exportField($this->ID);
                        $doc->exportField($this->Latitude);
                        $doc->exportField($this->Longitude);
