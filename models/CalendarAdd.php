...
class CalendarAdd extends Calendar
{
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->AllDay->Visible && $this->AllDay->Required) {
            ...
            if ($this->GroupId->Visible && $this->GroupId->Required) {
            ...
            if ($this->ClassNames->Visible && $this->ClassNames->Required) {
            ...
            if ($this->BackgroundColor->Visible && $this->BackgroundColor->Required) {
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['Start'])) { // Start
            $this->Start->setFormValue($row['Start']);
        }
        if (isset($row['End'])) { // End
            $this->End->setFormValue($row['End']);
        }
        if (isset($row['AllDay'])) { // AllDay
            $this->AllDay->setFormValue($row['AllDay']);
        }
        if (isset($row['Description'])) { // Description
            $this->Description->setFormValue($row['Description']);
        }
        if (isset($row['GroupId'])) { // GroupId
            $this->GroupId->setFormValue($row['GroupId']);
        }
        if (isset($row['Url'])) { // Url
            $this->Url->setFormValue($row['Url']);
        }
        if (isset($row['ClassNames'])) { // ClassNames
            $this->ClassNames->setFormValue($row['ClassNames']);
        }
        if (isset($row['Display'])) { // Display
            $this->Display->setFormValue($row['Display']);
        }
        if (isset($row['BackgroundColor'])) { // BackgroundColor
            $this->BackgroundColor->setFormValue($row['BackgroundColor']);
        }
    }
