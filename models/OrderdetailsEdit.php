 ...
 * Page class
 */
class OrderdetailsEdit extends Orderdetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OrderdetailsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "orderdetailsedit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            ...
            if (($keyValue = Get("ProductID") ?? Key(1) ?? Route(3)) !== null) {
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        if ($this->OrderID->CurrentValue != null && $this->ProductID->CurrentValue != null) {
                            while ($this->fetch()) {
