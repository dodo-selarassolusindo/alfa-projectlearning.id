 ...
 * Page class
 */
class TrademarksAddopt extends Trademarks
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TrademarksAddopt";
    ...
    // CSS class/style
    public $CurrentPageName = "trademarksaddopt";
    ...
    {
        global $CurrentForm;
        $this->Trademark->CurrentValue = ConvertToUtf8($this->Trademark->FormValue);
    }
