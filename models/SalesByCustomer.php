...
/**
 * Table class for Sales By Customer
 */
class SalesByCustomer extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "Sales_By_Customer";
        $this->TableName = 'Sales By Customer';
    ...
    {
        return $this->sqlSelectAggregate ?? $this->getQueryBuilder()->select("AVG(`Quantity`) AS avg_quantity, SUM(`Extended Price`) AS sum_extendedprice");
    }
    ...
    {
        $this->CompanyName->setExpanded($this->GroupCounter[1] == 1); // Set first group
        $this->OrderID->setExpanded(@$this->GroupCounter[2] == 1); // Set second group
    }
