...
/**
 * Table class for gantt3
 */
class Gantt3 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "gantt3";
        $this->TableName = 'gantt3';
        $this->TableType = "LINKTABLE";

        // Update Table
        $this->UpdateTable = "gantt";
        $this->Dbid = 'demo2';
        ...
        $this->start = new DbField(
            ...
            'start', // Name
            '`start`', // Expression
            CastDateFieldForLike("`start`", 0, "demo2"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
        ...
        $this->end = new DbField(
            ...
            'end', // Name
            '`end`', // Expression
            CastDateFieldForLike("`end`", 0, "demo2"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
        ...
        $this->end->Raw = true;
        $this->end->Nullable = false; // NOT NULL field
        $this->end->Required = true; // Required field
        $this->end->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->end->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "gantt";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("gantt3list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "gantt3view" => $Language->phrase("View"),
            "gantt3edit" => $Language->phrase("Edit"),
            "gantt3add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "Gantt3View",
            Config("API_ADD_ACTION") => "Gantt3Add",
            Config("API_EDIT_ACTION") => "Gantt3Edit",
            Config("API_DELETE_ACTION") => "Gantt3Delete",
            Config("API_LIST_ACTION") => "Gantt3List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("gantt3view", $parm);
        } else {
            $url = $this->keyUrl("gantt3view", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("gantt3edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("gantt3list", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("gantt3add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("gantt3list", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("gantt3delete", $parm);
        }
    }
