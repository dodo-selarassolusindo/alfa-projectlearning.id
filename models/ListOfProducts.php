...
/**
 * Table class for list_of_products
 */
class ListOfProducts extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "list_of_products";
        ...
        // Update Table
        $this->UpdateTable = "list_of_products";
        $this->Dbid = 'DB';
        ...
        $this->UnitsInStock->addMethod("getDefault", fn() => 0);
        $this->UnitsInStock->InputTextType = "text";
        $this->UnitsInStock->Raw = true;
        ...
        // ProductName2
        $this->ProductName2 = new DbField(
            $this, // Table
            'x_ProductName2', // Variable name
            'ProductName2', // Name
            '`ProductName2`', // Expression
            '`ProductName2`', // Basic search expression
            200, // Type
            40, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`ProductName2`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->ProductName2->InputTextType = "text";
        $this->ProductName2->Nullable = false; // NOT NULL field
        $this->ProductName2->Required = true; // Required field
        $this->ProductName2->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['ProductName2'] = &$this->ProductName2;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "list_of_products";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->ProductName2->DbValue = $row['ProductName2'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("listofproductslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "listofproductsview" => $Language->phrase("View"),
            "listofproductsedit" => $Language->phrase("Edit"),
            "listofproductsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ListOfProductsView",
            Config("API_ADD_ACTION") => "ListOfProductsAdd",
            Config("API_EDIT_ACTION") => "ListOfProductsEdit",
            Config("API_DELETE_ACTION") => "ListOfProductsDelete",
            Config("API_LIST_ACTION") => "ListOfProductsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("listofproductsview", $parm);
        } else {
            $url = $this->keyUrl("listofproductsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "listofproductsadd?" . $parm;
        } else {
            $url = "listofproductsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("listofproductsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("listofproductslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("listofproductsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("listofproductslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("listofproductsdelete", $parm);
        }
    }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->ProductName2->setDbValue($row['ProductName2']);
    }
    ...
    public function renderListRow()
    {
        ...
        $this->UnitsInStock->ViewValue = FormatNumber($this->UnitsInStock->ViewValue, $this->UnitsInStock->formatPattern());

        // ProductName2
        $this->ProductName2->ViewValue = $this->ProductName2->CurrentValue;
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->UnitsInStock->EditValue) != "" && is_numeric($this->UnitsInStock->EditValue)) {
            $this->UnitsInStock->EditValue = FormatNumber($this->UnitsInStock->EditValue, null);
        }

        // ProductName2
        $this->ProductName2->setupEditAttributes();
        if (!$this->ProductName2->Raw) {
            $this->ProductName2->CurrentValue = HtmlDecode($this->ProductName2->CurrentValue);
        }
        $this->ProductName2->EditValue = $this->ProductName2->CurrentValue;
        $this->ProductName2->PlaceHolder = RemoveHtml($this->ProductName2->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->ProductName2);
                } else {
                    $doc->exportCaption($this->ProductName);
                    $doc->exportCaption($this->CategoryName);
                    $doc->exportCaption($this->QuantityPerUnit);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->ProductName2);
                    } else {
                        $doc->exportField($this->ProductName);
                        $doc->exportField($this->CategoryName);
                        $doc->exportField($this->QuantityPerUnit);
