...
/**
 * Table class for sales_by_year
 */
class SalesByYear2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "sales_by_year2";
        $this->TableName = 'sales_by_year';
        $this->TableType = "VIEW";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "sales_by_year";
        $this->Dbid = 'DB';
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("salesbyyear2list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "salesbyyear2view" => $Language->phrase("View"),
            "salesbyyear2edit" => $Language->phrase("Edit"),
            "salesbyyear2add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "SalesByYear2View",
            Config("API_ADD_ACTION") => "SalesByYear2Add",
            Config("API_EDIT_ACTION") => "SalesByYear2Edit",
            Config("API_DELETE_ACTION") => "SalesByYear2Delete",
            Config("API_LIST_ACTION") => "SalesByYear2List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("salesbyyear2view", $parm);
        } else {
            $url = $this->keyUrl("salesbyyear2view", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("salesbyyear2edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("salesbyyear2list", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("salesbyyear2add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("salesbyyear2list", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("salesbyyear2delete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->Year->EditValue) != "" && is_numeric($this->Year->EditValue)) {
            $this->Year->EditValue = FormatNumber($this->Year->EditValue, null);
        }
