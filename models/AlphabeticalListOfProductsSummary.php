 ...
 * Page class
 */
class AlphabeticalListOfProductsSummary extends AlphabeticalListOfProducts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlphabeticalListOfProductsSummary";
    ...
    public $CurrentPageName = "alphabeticallistofproducts";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'Alphabetical_List_of_Products';
        ...
        // Table object (Alphabetical_List_of_Products)
        if (!isset($GLOBALS["Alphabetical_List_of_Products"]) || $GLOBALS["Alphabetical_List_of_Products"]::class == PROJECT_NAMESPACE . "Alphabetical_List_of_Products") {
            $GLOBALS["Alphabetical_List_of_Products"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Alphabetical List of Products');
        }
    ...
    public function loadGroupRowValues()
    {
        ...
        if ($this->GroupCount < $cnt) {
            $this->ProductName2->setGroupValue(reset($this->GroupRecords[$this->GroupCount]));
        } else {
            $this->ProductName2->setGroupValue("");
        }
    }
    ...
    public function loadRowValues($record)
    {
        ...
        $data["QuantityPerUnit"] = $record['QuantityPerUnit'];
        $data["UnitsInStock"] = $record['UnitsInStock'];
        $data["ProductName2"] = $record['ProductName2'];
        $this->Rows[] = $data;
        $this->ProductName->setDbValue($record['ProductName']);
        $this->CategoryName->setDbValue($record['CategoryName']);
        $this->QuantityPerUnit->setDbValue($record['QuantityPerUnit']);
        $this->UnitsInStock->setDbValue($record['UnitsInStock']);
        $this->ProductName2->setDbValue(GroupValue($this->ProductName2, $record['ProductName2']));
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::TOTAL && $this->RowTotalSubType == RowTotal::FOOTER && $this->RowTotalType == RowSummary::PAGE) {
            ...
            $rs = $sql->executeQuery();
            $records = $rs?->fetchAll() ?? [];
            $this->UnitsInStock->getSum($records, false);
            ...
            if ($rsagg) {
                ...
                $this->CategoryName->Count = $this->TotalCount;
                $this->QuantityPerUnit->Count = $this->TotalCount;
                $this->UnitsInStock->Count = $this->TotalCount;
                $this->UnitsInStock->SumValue = $rsagg["sum_unitsinstock"];
                $hasSummary = true;
            }
            ...
            if (!$hasCount || !$hasSummary) {
                ...
                $this->UnitsInStock->getSum($this->DetailRecords, false);
            }
        }
        ...
        if ($this->RowType == RowType::SEARCH) { // Search row
            ...
            if ($this->RowTotalType == RowSummary::GROUP) {
                $this->RowAttrs["data-group"] = $this->ProductName2->groupValue(); // Set up group attribute
            }

            // ProductName2
            $this->ProductName2->GroupViewValue = $this->ProductName2->groupValue();
            $this->ProductName2->CellCssClass = ($this->RowGroupLevel == 1 ? "ew-rpt-grp-summary-1" : "ew-rpt-grp-field-1");
            $this->ProductName2->GroupViewValue = DisplayGroupValue($this->ProductName2, $this->ProductName2->GroupViewValue);

            // UnitsInStock
            $this->UnitsInStock->SumViewValue = $this->UnitsInStock->SumValue;
            $this->UnitsInStock->SumViewValue = FormatNumber($this->UnitsInStock->SumViewValue, $this->UnitsInStock->formatPattern());
            $this->UnitsInStock->CellAttrs["class"] = ($this->RowTotalType == RowSummary::PAGE || $this->RowTotalType == RowSummary::GRAND) ? "ew-rpt-grp-aggregate" : "ew-rpt-grp-summary-" . $this->RowGroupLevel;

            // ProductName2
            $this->ProductName2->HrefValue = "";
            ...
            // ProductName2
            $this->ProductName2->GroupViewValue = $this->ProductName2->groupValue();
            $this->ProductName2->CellCssClass = "ew-rpt-grp-field-1";
            $this->ProductName2->GroupViewValue = DisplayGroupValue($this->ProductName2, $this->ProductName2->GroupViewValue);
            if (!$this->ProductName2->LevelBreak) {
                $this->ProductName2->GroupViewValue = "";
            } else {
                $this->ProductName2->LevelBreak = false;
            }
            ...
            $this->CategoryName->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // QuantityPerUnit
            $this->QuantityPerUnit->ViewValue = $this->QuantityPerUnit->CurrentValue;
            $this->QuantityPerUnit->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // UnitsInStock
            $this->UnitsInStock->ViewValue = $this->UnitsInStock->CurrentValue;
            $this->UnitsInStock->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // ProductName2
            $this->ProductName2->HrefValue = "";
            $this->ProductName2->TooltipValue = "";
        ...
        if ($this->RowType == RowType::TOTAL) {
            // ProductName2
            $currentValue = $this->ProductName2->GroupViewValue;
            $viewValue = &$this->ProductName2->GroupViewValue;
            $viewAttrs = &$this->ProductName2->ViewAttrs;
            $cellAttrs = &$this->ProductName2->CellAttrs;
            $hrefValue = &$this->ProductName2->HrefValue;
            $linkAttrs = &$this->ProductName2->LinkAttrs;
            $this->cellRendered($this->ProductName2, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // UnitsInStock
            $currentValue = $this->UnitsInStock->SumValue;
            $viewValue = &$this->UnitsInStock->SumViewValue;
            $viewAttrs = &$this->UnitsInStock->ViewAttrs;
            $cellAttrs = &$this->UnitsInStock->CellAttrs;
            $hrefValue = &$this->UnitsInStock->HrefValue;
            $linkAttrs = &$this->UnitsInStock->LinkAttrs;
            $this->cellRendered($this->UnitsInStock, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        } else {
            // ProductName2
            $currentValue = $this->ProductName2->groupValue();
            $viewValue = &$this->ProductName2->GroupViewValue;
            $viewAttrs = &$this->ProductName2->ViewAttrs;
            $cellAttrs = &$this->ProductName2->CellAttrs;
            $hrefValue = &$this->ProductName2->HrefValue;
            ...
            // CategoryName
            $currentValue = $this->CategoryName->CurrentValue;
            $viewValue = &$this->CategoryName->ViewValue;
            ...
            // QuantityPerUnit
            $currentValue = $this->QuantityPerUnit->CurrentValue;
            $viewValue = &$this->QuantityPerUnit->ViewValue;
            $viewAttrs = &$this->QuantityPerUnit->ViewAttrs;
            $cellAttrs = &$this->QuantityPerUnit->CellAttrs;
            $hrefValue = &$this->QuantityPerUnit->HrefValue;
            $linkAttrs = &$this->QuantityPerUnit->LinkAttrs;
            $this->cellRendered($this->QuantityPerUnit, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // UnitsInStock
            $currentValue = $this->UnitsInStock->CurrentValue;
            $viewValue = &$this->UnitsInStock->ViewValue;
            $viewAttrs = &$this->UnitsInStock->ViewAttrs;
            $cellAttrs = &$this->UnitsInStock->CellAttrs;
            $hrefValue = &$this->UnitsInStock->HrefValue;
            $linkAttrs = &$this->UnitsInStock->LinkAttrs;
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->QuantityPerUnit->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->UnitsInStock->Visible) {
            $this->DetailColumnCount += 1;
        }
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fAlphabetical_List_of_Productssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fAlphabetical_List_of_Productssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    protected function getSort()
    {
        ...
        // Check for an Order parameter
            ...
            $this->updateSort($this->ProductName2); // ProductName2
