 ...
 * Page class
 */
class ProductsDelete extends Products
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProductsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "productsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("productslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("productslist"); // Return to list
                return;
            }
        }
