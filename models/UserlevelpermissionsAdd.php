...
class UserlevelpermissionsAdd extends Userlevelpermissions
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if (strval($this->_permission->EditValue) != "" && is_numeric($this->_permission->EditValue)) {
                $this->_permission->EditValue = $this->_permission->EditValue;
            }
    ...
    protected function getAddRow()
    {
        ...
        // permission
        $this->_permission->setDbValueDef($rsnew, $this->_permission->CurrentValue, false);
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['tablename'])) { // tablename
            $this->_tablename->setFormValue($row['tablename']);
        }
        if (isset($row['permission'])) { // permission
            $this->_permission->setFormValue($row['permission']);
        }
    }
