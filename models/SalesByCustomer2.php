...
/**
 * Table class for Sales By Customer 2
 */
class SalesByCustomer2 extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->ReportSourceTable = 'order_details_extended_2'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = false;
        $this->ExportPageBreakCount = 0; // Page break per every n record (report only)
        $this->ExportPageBreaks = false; // Disable page break for custom template
        ...
        $this->CompanyName->GroupingFieldId = 1;
        $this->CompanyName->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->CompanyName->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->CompanyName->GroupByType = "";
        $this->CompanyName->GroupInterval = "0";
        $this->CompanyName->GroupSql = "";
        ...
        $this->CompanyName->SourceTableVar = 'order_details_extended_2';
        ...
        $this->OrderID->GroupingFieldId = 2;
        $this->OrderID->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->OrderID->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->OrderID->GroupByType = "";
        $this->OrderID->GroupInterval = "0";
        $this->OrderID->GroupSql = "";
        ...
        $this->OrderID->setSelectMultiple(false); // Select one
        ...
        $this->OrderID->Lookup = new Lookup($this->OrderID, 'order_details_extended_2', true, 'OrderID', ["OrderID","","",""], '', '', [], [], [], [], [], [], false, '`OrderID` ASC', '', "`OrderID`");
        $this->OrderID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->OrderID->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->OrderID->SourceTableVar = 'order_details_extended_2';
        $this->OrderID->SearchType = "dropdown";
        ...
        $this->ProductName->SourceTableVar = 'order_details_extended_2';
        $this->Fields['ProductName'] = &$this->ProductName;

        // UnitPrice
        $this->UnitPrice = new ReportField(
            $this, // Table
        ...
        $this->UnitPrice->addMethod("getDefault", fn() => 0);
        $this->UnitPrice->InputTextType = "text";
        $this->UnitPrice->Raw = true;
        ...
        $this->UnitPrice->SourceTableVar = 'order_details_extended_2';
        ...
        $this->Quantity->SourceTableVar = 'order_details_extended_2';
        $this->Fields['Quantity'] = &$this->Quantity;

        // Discount
        $this->Discount = new ReportField(
            $this, // Table
        ...
        $this->Discount->addMethod("getDefault", fn() => 0);
        ...
        $this->Discount->SourceTableVar = 'order_details_extended_2';
        $this->Fields['Discount'] = &$this->Discount;

        // Extended Price
        $this->ExtendedPrice = new ReportField(
            $this, // Table
        ...
        $this->ExtendedPrice->addMethod("getDefault", fn() => 0);
        $this->ExtendedPrice->InputTextType = "text";
        $this->ExtendedPrice->Raw = true;
        ...
        $this->ExtendedPrice->SourceTableVar = 'order_details_extended_2';
        ...
        RegisterFilterGroup($this->OrderDate, "RelativeWeeks");
        ...
        $this->OrderDate->SourceTableVar = 'order_details_extended_2';
        $this->Fields['OrderDate'] = &$this->OrderDate;

        // ContactName
        $this->ContactName = new ReportField(
            $this, // Table
        ...
        $this->ContactName->SourceTableVar = 'order_details_extended_2';
        $this->Fields['ContactName'] = &$this->ContactName;

        // ContactTitle
        $this->ContactTitle = new ReportField(
            $this, // Table
        ...
        $this->ContactTitle->SourceTableVar = 'order_details_extended_2';
        $this->Fields['ContactTitle'] = &$this->ContactTitle;

        // Address
        $this->Address = new ReportField(
            $this, // Table
        ...
        $this->Address->SourceTableVar = 'order_details_extended_2';
        $this->Fields['Address'] = &$this->Address;

        // City
        $this->City = new ReportField(
            $this, // Table
        ...
        $this->City->SourceTableVar = 'order_details_extended_2';
        $this->Fields['City'] = &$this->City;

        // Region
        $this->Region = new ReportField(
            $this, // Table
        ...
        $this->Region->SourceTableVar = 'order_details_extended_2';
        $this->Fields['Region'] = &$this->Region;

        // PostalCode
        $this->PostalCode = new ReportField(
            $this, // Table
        ...
        $this->PostalCode->SourceTableVar = 'order_details_extended_2';
        $this->Fields['PostalCode'] = &$this->PostalCode;

        // Country
        $this->Country = new ReportField(
            $this, // Table
        ...
        $this->Country->SourceTableVar = 'order_details_extended_2';
        ...
        $this->Phone->SourceTableVar = 'order_details_extended_2';
    ...
    public function getSqlFirstGroupField($alias = false)
    {
        ...
        $firstGroupField = &$this->CompanyName;
    ...
    {
        return $this->sqlSelectAggregate ?? $this->getQueryBuilder()->select("SUM(`Quantity`) AS sum_quantity, SUM(`Extended Price`) AS sum_extendedprice");
    }
    ...
    {
        $this->OrderID->ViewValue = GetDropDownDisplayValue($this->OrderID->CurrentValue, "", 0);
    }
    ...
    {
        return "salesbycustomer2";
    }

    // API page name
    public function getApiPageName($action)
    {
        return "SalesByCustomer2Summary";
    }
    ...
    {
        $json = "";
        $json .= "\"OrderID\":" . VarToJson($this->OrderID->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
