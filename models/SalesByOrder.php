...
/**
 * Table class for Sales By Order
 */
class SalesByOrder extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->CompanyName->GroupingFieldId = 2;
        ...
        $this->CompanyName->Lookup = new Lookup($this->CompanyName, 'order_details_extended', true, 'CompanyName', ["CompanyName","","",""], '', '', [], [], [], [], [], [], false, '`CompanyName` ASC', '', "`CompanyName`");
        ...
        $this->OrderID->GroupingFieldId = 1;
