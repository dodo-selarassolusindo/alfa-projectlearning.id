...
class Categories extends DbTable
{
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "categoriesview" => $Language->phrase("View"),
            "categoriesedit" => $Language->phrase("Edit"),
            "categoriesadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "CategoriesView",
            Config("API_ADD_ACTION") => "CategoriesAdd",
            Config("API_EDIT_ACTION") => "CategoriesEdit",
            Config("API_DELETE_ACTION") => "CategoriesDelete",
            Config("API_LIST_ACTION") => "CategoriesList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("categoriesdelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"CategoryID\":" . VarToJson($this->CategoryID->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
