...
class CarsDelete extends Cars
{
    ...
    // CSS class/style
    public $CurrentPageName = "carsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("carslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("carslist"); // Return to list
                return;
            }
        }
