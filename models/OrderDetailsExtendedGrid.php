 ...
 * Page class
 */
class OrderDetailsExtendedGrid extends OrderDetailsExtended
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OrderDetailsExtendedGrid";
    ...
    public $FormName = "forder_details_extendedgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "orderdetailsextendedgrid";
    ...
    protected function clearInlineMode()
    {
        ...
        $this->ExtendedPrice->FormValue = ""; // Clear form value
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->ExtendedPrice->DefaultValue = $this->ExtendedPrice->getDefault(); // PHP
        $this->ExtendedPrice->OldValue = $this->ExtendedPrice->DefaultValue;
    }
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'Extended Price' first before field var 'x_ExtendedPrice'
        $val = $CurrentForm->hasValue("Extended Price") ? $CurrentForm->getValue("Extended Price") : $CurrentForm->getValue("x_ExtendedPrice");
        if (!$this->ExtendedPrice->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->ExtendedPrice->Visible = false; // Disable update for API request
            } else {
                $this->ExtendedPrice->setFormValue($val, true, $validate);
            }
        }
        if ($CurrentForm->hasValue("o_ExtendedPrice")) {
            $this->ExtendedPrice->setOldValue($CurrentForm->getValue("o_ExtendedPrice"));
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        $this->ExtendedPrice->CurrentValue = $this->ExtendedPrice->FormValue;
    }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->ExtendedPrice->Visible && $this->ExtendedPrice->Required) {
                if (!$this->ExtendedPrice->IsDetailKey && EmptyValue($this->ExtendedPrice->FormValue)) {
                    $this->ExtendedPrice->addErrorMessage(str_replace("%s", $this->ExtendedPrice->caption(), $this->ExtendedPrice->RequiredErrorMessage));
                }
            }
    ...
    protected function getEditRow($rsold)
    {
        ...
        // Extended Price
        $this->ExtendedPrice->setDbValueDef($rsnew, $this->ExtendedPrice->CurrentValue, $this->ExtendedPrice->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['ProductName'])) { // ProductName
            $this->ProductName->CurrentValue = $row['ProductName'];
        }
        ...
        if (isset($row['Extended Price'])) { // Extended Price
            $this->ExtendedPrice->CurrentValue = $row['Extended Price'];
        }
    }
    ...
    protected function getAddRow()
    {
        ...
        // Extended Price
        $this->ExtendedPrice->setDbValueDef($rsnew, $this->ExtendedPrice->CurrentValue, strval($this->ExtendedPrice->CurrentValue) == "");
        return $rsnew;
    }
    ...
    {
        if (isset($row['CompanyName'])) { // CompanyName
            $this->CompanyName->setFormValue($row['CompanyName']);
        }
        if (isset($row['ProductName'])) { // ProductName
            $this->ProductName->setFormValue($row['ProductName']);
        }
        if (isset($row['UnitPrice'])) { // UnitPrice
        ...
        if (isset($row['Extended Price'])) { // Extended Price
            $this->ExtendedPrice->setFormValue($row['Extended Price']);
        }
    }
