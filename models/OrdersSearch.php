        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->EmployeeID->AdvancedSearch->ViewValue !== null) { // Load from cache
                ...
                if ($curVal == "") {
                    ...
                    $filterWrk = SearchFilter($this->EmployeeID->Lookup->getTable()->Fields["EmployeeID"]->searchExpression(), "=", $this->EmployeeID->AdvancedSearch->SearchValue, $this->EmployeeID->Lookup->getTable()->Fields["EmployeeID"]->searchDataType(), "");
                }
            ...
            $this->ShipVia->EditValue = $this->ShipVia->AdvancedSearch->SearchValue;
