...
class Suppliers extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->SupplierID->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "suppliersview" => $Language->phrase("View"),
            "suppliersedit" => $Language->phrase("Edit"),
            "suppliersadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "SuppliersView",
            Config("API_ADD_ACTION") => "SuppliersAdd",
            Config("API_EDIT_ACTION") => "SuppliersEdit",
            Config("API_DELETE_ACTION") => "SuppliersDelete",
            Config("API_LIST_ACTION") => "SuppliersList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("suppliersdelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"SupplierID\":" . VarToJson($this->SupplierID->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
