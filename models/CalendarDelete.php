 ...
 * Page class
 */
class CalendarDelete extends Calendar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CalendarDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "calendardelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("calendarlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("calendarlist"); // Return to list
                return;
            }
        }
