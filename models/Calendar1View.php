 ...
 * Page class
 */
class Calendar1View extends Calendar1
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Calendar1View";
    ...
    public $CurrentPageName = "calendar1view";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Id") ?? Route("Id")) !== null) {
            ...
            $returnUrl = "calendar1list"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "calendar1list"; // No matching record, return to list
                    } else {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fCalendar1view" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
