...
class CategoriesSearch extends Categories
{
    ...
    // Page object name
    public $PageObjName = "CategoriesSearch";
    ...
    // CSS class/style
    public $CurrentPageName = "categoriessearch";
    ...
    public function run()
    {
        ...
        if ($this->isSearch()) {
            ...
            if ($srchStr != "") {
                $srchStr = "categorieslist" . "?" . $srchStr;
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->CategoryName); // CategoryName
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->CategoryID->AdvancedSearch->SearchValue)) {
