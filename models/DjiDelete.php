...
class DjiDelete extends Dji
{
    ...
    // CSS class/style
    public $CurrentPageName = "djidelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("djilist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("djilist"); // Return to list
                return;
            }
        }
