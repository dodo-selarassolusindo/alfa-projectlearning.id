...
/**
 * Table class for orders2
 */
class Orders2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->CustomerID->Lookup = new Lookup($this->CustomerID, 'customers', false, 'CustomerID', ["CompanyName","","",""], '', '', [], [], [], [], [], [], false, '', '', "`CompanyName`");
        ...
        $this->EmployeeID->Lookup = new Lookup($this->EmployeeID, 'employees', false, 'EmployeeID', ["LastName","FirstName","",""], '', '', [], [], [], [], [], [], false, '', '', "CONCAT(COALESCE(`LastName`, ''),'" . ValueSeparator(1, $this->EmployeeID) . "',COALESCE(`FirstName`,''))");
        ...
        $this->Freight->addMethod("getDefault", fn() => 0);
    ...
    {
        if ($chartVar == "FreightByEmployees") {
            $this->EmployeeID->CurrentValue = $chartRow[0];
            ...
            $chartRow[0] = is_object($this->EmployeeID->ViewValue) ? $this->EmployeeID->ViewValue->__toString() : $this->EmployeeID->ViewValue;
        }
        return $chartRow;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "orders2";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("orders2list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "orders2view" => $Language->phrase("View"),
            "orders2edit" => $Language->phrase("Edit"),
            "orders2add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "Orders2View",
            Config("API_ADD_ACTION") => "Orders2Add",
            Config("API_EDIT_ACTION") => "Orders2Edit",
            Config("API_DELETE_ACTION") => "Orders2Delete",
            Config("API_LIST_ACTION") => "Orders2List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("orders2view", $parm);
        } else {
            $url = $this->keyUrl("orders2view", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("orders2edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("orders2list", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("orders2add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("orders2list", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("orders2delete", $parm);
        }
    }
    ...
    public function tableLoad()
    {
        ...
        $this->FreightByEmployees->ScaleBeginWithZero = true; // Chart scale starts at zero
    }
