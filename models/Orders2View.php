 ...
 * Page class
 */
class Orders2View extends Orders2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Orders2View";
    ...
    // CSS class/style
    public $CurrentPageName = "orders2view";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("OrderID") ?? Route("OrderID")) !== null) {
            ...
            $returnUrl = "orders2list"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("orders2list"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "orders2list"; // No matching record, return to list
                    } else {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="forders2view" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
