 ...
 * Page class
 */
class Orders2Delete extends Orders2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Orders2Delete";
    ...
    // CSS class/style
    public $CurrentPageName = "orders2delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("orders2list"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("orders2list"); // Return to list
                return;
            }
        }
