...
class OrderDetailsExtended extends DbTable
{
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "orderdetailsextendedview" => $Language->phrase("View"),
            "orderdetailsextendededit" => $Language->phrase("Edit"),
            "orderdetailsextendedadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "OrderDetailsExtendedView",
            Config("API_ADD_ACTION") => "OrderDetailsExtendedAdd",
            Config("API_EDIT_ACTION") => "OrderDetailsExtendedEdit",
            Config("API_DELETE_ACTION") => "OrderDetailsExtendedDelete",
            Config("API_LIST_ACTION") => "OrderDetailsExtendedList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("orderdetailsextendeddelete", $parm);
        }
    }
