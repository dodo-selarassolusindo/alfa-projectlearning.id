 ...
 */
class OrderDetailsExtended2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("orderdetailsextended2list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "orderdetailsextended2view" => $Language->phrase("View"),
            "orderdetailsextended2edit" => $Language->phrase("Edit"),
            "orderdetailsextended2add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "orderdetailsextended2list";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "OrderDetailsExtended2View",
            Config("API_ADD_ACTION") => "OrderDetailsExtended2Add",
            Config("API_EDIT_ACTION") => "OrderDetailsExtended2Edit",
            Config("API_DELETE_ACTION") => "OrderDetailsExtended2Delete",
            Config("API_LIST_ACTION") => "OrderDetailsExtended2List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("orderdetailsextended2view", $parm);
        } else {
            $url = $this->keyUrl("orderdetailsextended2view", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "orderdetailsextended2add?" . $parm;
        } else {
            $url = "orderdetailsextended2add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("orderdetailsextended2edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("orderdetailsextended2list", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("orderdetailsextended2add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("orderdetailsextended2list", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("orderdetailsextended2delete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "OrderDetailsExtended2List";
