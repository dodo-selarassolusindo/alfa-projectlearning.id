 ...
 * Page class
 */
class SuppliersDelete extends Suppliers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SuppliersDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "suppliersdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("supplierslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("supplierslist"); // Return to list
                return;
            }
        }
