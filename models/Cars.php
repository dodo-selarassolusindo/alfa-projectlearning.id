...
class Cars extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Model->Lookup = new Lookup($this->Model, 'models', true, 'ID', ["Model","","",""], '', '', ["x_Trademark"], [], ["Trademark"], ["x_Trademark"], [], [], false, '', '', "`Model`");
        ...
        $this->TransmissAutomatic->Lookup = new Lookup($this->TransmissAutomatic, 'cars', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getSqlSelectList()
    {
        ...
        $from = "(SELECT " . $this->sqlSelectFields() . ", (SELECT `Trademark` FROM trademarks TMP_LOOKUPTABLE WHERE TMP_LOOKUPTABLE.ID = cars.Trademark LIMIT 1) AS EV__Trademark, (SELECT DISTINCT `Model` FROM models TMP_LOOKUPTABLE WHERE TMP_LOOKUPTABLE.ID = cars.Model LIMIT 1) AS EV__Model FROM cars)";
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "carsview" => $Language->phrase("View"),
            "carsedit" => $Language->phrase("Edit"),
            "carsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "CarsView",
            Config("API_ADD_ACTION") => "CarsAdd",
            Config("API_EDIT_ACTION") => "CarsEdit",
            Config("API_DELETE_ACTION") => "CarsDelete",
            Config("API_LIST_ACTION") => "CarsList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("carsdelete", $parm);
        }
    }
    ...
    public function renderListRow()
    {
        ...
        if (!$this->isExport()) {
            ...
            $this->Model->LinkAttrs["data-tooltip-id"] = "tt_cars_x" . (($this->RowType != RowType::MASTER) ? @$this->RowCount : "") . "_Model";
