...
class Products extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->ProductID->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->ProductName->Lookup = new Lookup($this->ProductName, 'products', true, 'ProductName', ["ProductName","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->SupplierID->Lookup = new Lookup($this->SupplierID, 'suppliers', false, 'SupplierID', ["CompanyName","","",""], '', '', [], [], [], [], [], [], false, '', '', "`CompanyName`");
        ...
        $this->CategoryID->Lookup = new Lookup($this->CategoryID, 'categories', false, 'CategoryID', ["CategoryName","","",""], '', '', [], [], [], [], [], [], false, '', '', "`CategoryName`");
        ...
        $this->UnitsOnOrder->addMethod("getDefault", fn() => 0);
        $this->UnitsOnOrder->InputTextType = "text";
        $this->UnitsOnOrder->Raw = true;
        ...
        $this->ReorderLevel->addMethod("getDefault", fn() => 0);
        $this->ReorderLevel->InputTextType = "text";
        $this->ReorderLevel->Raw = true;
        ...
        $this->Discontinued->Lookup = new Lookup($this->Discontinued, 'products', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "productsview" => $Language->phrase("View"),
            "productsedit" => $Language->phrase("Edit"),
            "productsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ProductsView",
            Config("API_ADD_ACTION") => "ProductsAdd",
            Config("API_EDIT_ACTION") => "ProductsEdit",
            Config("API_DELETE_ACTION") => "ProductsDelete",
            Config("API_LIST_ACTION") => "ProductsList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("productsdelete", $parm);
        }
    }
