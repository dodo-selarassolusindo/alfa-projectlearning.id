 ...
 * Page class
 */
class ModelsAdd extends Models
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "modelsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("modelslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "modelslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "modelsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "modelslist") {
                            ...
                            $returnUrl = "modelslist"; // Return list page content
                        }
                    }
    ...
    public function renderAddOpt($row)
    {
        ...
        $this->Model->CurrentValue = $row["Model"] ?? null;
        ...
        // Set up $row
        $row["Model"] = $this->Model->ViewValue;
        return $row;
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("modelslist"), "", $this->TableVar, true);
