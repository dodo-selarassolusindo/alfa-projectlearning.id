...
class Customers extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->CustomerID->Lookup = new Lookup($this->CustomerID, 'customers', false, 'CustomerID', ["CustomerID","","",""], '', '', [], [], [], [], [], [], false, '', '', "`CustomerID`");
        $this->CustomerID->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        $json = "";
        $json .= "\"CustomerID\":" . VarToJson($this->CustomerID->CurrentValue, "string");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
