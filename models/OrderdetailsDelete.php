 ...
 * Page class
 */
class OrderdetailsDelete extends Orderdetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OrderdetailsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "orderdetailsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("orderdetailslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("orderdetailslist"); // Return to list
                return;
            }
        }
