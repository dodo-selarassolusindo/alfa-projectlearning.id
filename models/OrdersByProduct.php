...
/**
 * Table class for orders_by_product
 */
class OrdersByProduct extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "orders_by_product";
        $this->TableName = 'orders_by_product';
        $this->TableType = "VIEW";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "orders_by_product";
        $this->Dbid = 'DB';
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ordersbyproductlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ordersbyproductview" => $Language->phrase("View"),
            "ordersbyproductedit" => $Language->phrase("Edit"),
            "ordersbyproductadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "OrdersByProductView",
            Config("API_ADD_ACTION") => "OrdersByProductAdd",
            Config("API_EDIT_ACTION") => "OrdersByProductEdit",
            Config("API_DELETE_ACTION") => "OrdersByProductDelete",
            Config("API_LIST_ACTION") => "OrdersByProductList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ordersbyproductview", $parm);
        } else {
            $url = $this->keyUrl("ordersbyproductview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ordersbyproductadd?" . $parm;
        } else {
            $url = "ordersbyproductadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ordersbyproductedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ordersbyproductlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ordersbyproductadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ordersbyproductlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ordersbyproductdelete", $parm);
        }
    }
