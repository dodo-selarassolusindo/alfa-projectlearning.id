...
/**
 * Table class for products_by_category
 */
class ProductsByCategory2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "products_by_category2";
        $this->TableName = 'products_by_category';
        $this->TableType = "VIEW";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "products_by_category";
        $this->Dbid = 'DB';
        ...
        $this->Discontinued->Raw = true;
        $this->Discontinued->setDataType(DataType::BOOLEAN);
        $this->Discontinued->Lookup = new Lookup($this->Discontinued, 'products_by_category2', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("productsbycategory2list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "productsbycategory2view" => $Language->phrase("View"),
            "productsbycategory2edit" => $Language->phrase("Edit"),
            "productsbycategory2add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "productsbycategory2list";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ProductsByCategory2View",
            Config("API_ADD_ACTION") => "ProductsByCategory2Add",
            Config("API_EDIT_ACTION") => "ProductsByCategory2Edit",
            Config("API_DELETE_ACTION") => "ProductsByCategory2Delete",
            Config("API_LIST_ACTION") => "ProductsByCategory2List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("productsbycategory2view", $parm);
        } else {
            $url = $this->keyUrl("productsbycategory2view", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "productsbycategory2add?" . $parm;
        } else {
            $url = "productsbycategory2add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("productsbycategory2edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("productsbycategory2list", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("productsbycategory2add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("productsbycategory2list", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("productsbycategory2delete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ProductsByCategory2List";
