...
class ProductsView extends Products
{
    ...
    // Page object name
    public $PageObjName = "ProductsView";
    ...
    // CSS class/style
    public $CurrentPageName = "productsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("ProductID") ?? Route("ProductID")) !== null) {
            ...
            $returnUrl = "productslist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "productslist"; // No matching record, return to list
                    } else {
