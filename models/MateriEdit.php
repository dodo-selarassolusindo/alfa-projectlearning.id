 ...
 * Page class
 */
class MateriEdit extends Materi
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "materiedit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("materilist"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "materilist") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "materilist") {
                            ...
                            $returnUrl = "materilist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['Tipe'])) { // Tipe
            $this->Tipe->CurrentValue = $row['Tipe'];
        }
    }
