...
class PersonalData
{
    ...
    // CSS class/style
    public $CurrentPageName = "favorites";
    ...
    public function run()
    {
        ...
        $Breadcrumb = Breadcrumb::create("home")->add("personal_data", "PersonalDataTitle", CurrentUrl(), "ew-personal-data", "", true);
    ...
    {
        $fldNames = ["Username", "LastName", "FirstName", "Password", "Email"];
