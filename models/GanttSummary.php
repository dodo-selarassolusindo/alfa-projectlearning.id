 ...
 * Page class
 */
class GanttSummary extends Gantt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GanttSummary";
    ...
    public function __construct()
    {
        ...
        // Table object (Gantt)
        if (!isset($GLOBALS["Gantt"]) || $GLOBALS["Gantt"]::class == PROJECT_NAMESPACE . "Gantt") {
            $GLOBALS["Gantt"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Gantt');
        }
    ...
    public function loadRowValues($record)
    {
        ...
        $data["Milestone"] = $record['Milestone'];
        $data["Duration"] = $record['Duration'];
        $data["PercentComplete"] = $record['PercentComplete'];
        $data["Dependencies"] = $record['Dependencies'];
        $this->Rows[] = $data;
        $this->TaskID->setDbValue($record['TaskID']);
        $this->TaskName->setDbValue($record['TaskName']);
        $this->ResourceID->setDbValue($record['ResourceID']);
        $this->Start->setDbValue($record['Start']);
        $this->End->setDbValue($record['End']);
        $this->Description->setDbValue($record['Description']);
        $this->Milestone->setDbValue($record['Milestone']);
        $this->Duration->setDbValue($record['Duration']);
        $this->PercentComplete->setDbValue($record['PercentComplete']);
        $this->Dependencies->setDbValue($record['Dependencies']);
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::SEARCH) { // Search row
            ...
            $this->ResourceID->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->Start->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // End
            $this->End->ViewValue = $this->End->CurrentValue;
            $this->End->ViewValue = FormatDateTime($this->End->ViewValue, $this->End->formatPattern());
            $this->End->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->Milestone->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // Duration
            $this->Duration->ViewValue = $this->Duration->CurrentValue;
            $this->Duration->ViewValue = FormatNumber($this->Duration->ViewValue, $this->Duration->formatPattern());
            $this->Duration->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->PercentComplete->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // Dependencies
            $this->Dependencies->ViewValue = $this->Dependencies->CurrentValue;
            $this->Dependencies->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == RowType::TOTAL) { // Summary row
            ...
            // ResourceID
            $currentValue = $this->ResourceID->CurrentValue;
            $viewValue = &$this->ResourceID->ViewValue;
            $viewAttrs = &$this->ResourceID->ViewAttrs;
            $cellAttrs = &$this->ResourceID->CellAttrs;
            $hrefValue = &$this->ResourceID->HrefValue;
            $linkAttrs = &$this->ResourceID->LinkAttrs;
            $this->cellRendered($this->ResourceID, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            $this->cellRendered($this->Start, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            $this->cellRendered($this->End, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            // Milestone
            $currentValue = $this->Milestone->CurrentValue;
            $viewValue = &$this->Milestone->ViewValue;
            $viewAttrs = &$this->Milestone->ViewAttrs;
            $cellAttrs = &$this->Milestone->CellAttrs;
            $hrefValue = &$this->Milestone->HrefValue;
            $linkAttrs = &$this->Milestone->LinkAttrs;
            $this->cellRendered($this->Milestone, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // Duration
            $currentValue = $this->Duration->CurrentValue;
            $viewValue = &$this->Duration->ViewValue;
            $viewAttrs = &$this->Duration->ViewAttrs;
            $cellAttrs = &$this->Duration->CellAttrs;
            $hrefValue = &$this->Duration->HrefValue;
            $linkAttrs = &$this->Duration->LinkAttrs;
            $this->cellRendered($this->Duration, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // PercentComplete
            $currentValue = $this->PercentComplete->CurrentValue;
            $viewValue = &$this->PercentComplete->ViewValue;
            $viewAttrs = &$this->PercentComplete->ViewAttrs;
            $cellAttrs = &$this->PercentComplete->CellAttrs;
            $hrefValue = &$this->PercentComplete->HrefValue;
            $linkAttrs = &$this->PercentComplete->LinkAttrs;
            $this->cellRendered($this->PercentComplete, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // Dependencies
            $currentValue = $this->Dependencies->CurrentValue;
            $viewValue = &$this->Dependencies->ViewValue;
            $viewAttrs = &$this->Dependencies->ViewAttrs;
            $cellAttrs = &$this->Dependencies->CellAttrs;
            $hrefValue = &$this->Dependencies->HrefValue;
            $linkAttrs = &$this->Dependencies->LinkAttrs;
            $this->cellRendered($this->Dependencies, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        }
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->Milestone->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->Duration->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->PercentComplete->Visible) {
            $this->DetailColumnCount += 1;
        }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fGanttsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fGanttsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    protected function getSort()
    {
        ...
        if ($resetSort) {
            ...
            $this->Milestone->setSort("");
            $this->Duration->setSort("");
            $this->PercentComplete->setSort("");
            $this->Dependencies->setSort("");
        ...
        // Check for an Order parameter
            ...
            $this->updateSort($this->Milestone); // Milestone
            $this->updateSort($this->Duration); // Duration
            $this->updateSort($this->PercentComplete); // PercentComplete
            $this->updateSort($this->Dependencies); // Dependencies
