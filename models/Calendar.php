 ...
 */
class Calendar extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->AllDay->Lookup = new Lookup($this->AllDay, 'calendar', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        // BackgroundColor
        $this->BackgroundColor = new DbField(
            $this, // Table
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("calendarlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "calendarview" => $Language->phrase("View"),
            "calendaredit" => $Language->phrase("Edit"),
            "calendaradd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "CalendarView",
            Config("API_ADD_ACTION") => "CalendarAdd",
            Config("API_EDIT_ACTION") => "CalendarEdit",
            Config("API_DELETE_ACTION") => "CalendarDelete",
            Config("API_LIST_ACTION") => "CalendarList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("calendarview", $parm);
        } else {
            $url = $this->keyUrl("calendarview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("calendaredit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("calendarlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("calendaradd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("calendarlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("calendardelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->Start->EditValue = FormatDateTime($this->Start->CurrentValue, $this->Start->formatPattern());
        $this->Start->PlaceHolder = RemoveHtml($this->Start->caption());

        // End
        $this->End->setupEditAttributes();
        $this->End->EditValue = FormatDateTime($this->End->CurrentValue, $this->End->formatPattern());
        ...
        $this->ClassNames->EditValue = $this->ClassNames->CurrentValue;
        ...
        $this->BackgroundColor->EditValue = $this->BackgroundColor->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->AllDay);
                    $doc->exportCaption($this->Description);
                    $doc->exportCaption($this->GroupId);
                    $doc->exportCaption($this->Url);
                    $doc->exportCaption($this->ClassNames);
                    $doc->exportCaption($this->Display);
                    $doc->exportCaption($this->BackgroundColor);
                } else {
                    $doc->exportCaption($this->Id);
                    $doc->exportCaption($this->_Title);
                    $doc->exportCaption($this->Start);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->AllDay);
                        $doc->exportField($this->Description);
                        $doc->exportField($this->GroupId);
                        $doc->exportField($this->Url);
                        $doc->exportField($this->ClassNames);
                        $doc->exportField($this->Display);
                        $doc->exportField($this->BackgroundColor);
                    } else {
                        $doc->exportField($this->Id);
                        $doc->exportField($this->_Title);
                        $doc->exportField($this->Start);
