...
class UserlevelsDelete extends Userlevels
{
    ...
    // CSS class/style
    public $CurrentPageName = "userlevelsdelete";
        ...
        foreach ($rsold as $row) {
            ...
            if ($deleteRow === false) {
                ...
                if ($x_userlevelid != null) {
                    $conn->executeStatement("DELETE FROM " . Config("USER_LEVEL_PRIV_TABLE") . " WHERE " . Config("USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD") . " = " . $x_userlevelid); // Delete user rights as well
                }
            }
        }
