...
class Tasks extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // PercentComplete
        $this->PercentComplete = new DbField(
            $this, // Table
    ...
    public function renderEditRow()
    {
        ...
        $this->Milestone->EditValue = FormatDateTime($this->Milestone->CurrentValue, $this->Milestone->formatPattern());
