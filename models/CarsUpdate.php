        ...
        if ($rs = $this->loadRecordset()) {
            ...
            while ($row = $rs->fetch()) {
                if ($i == 1) {
                    ...
                    if (!CompareValue($this->Trademark->DbValue, $row['Trademark'])) {
                        $this->Trademark->CurrentValue = null;
                    }
                    if (!CompareValue($this->Model->DbValue, $row['Model'])) {
                        $this->Model->CurrentValue = null;
                    }
                    if (!CompareValue($this->HP->DbValue, $row['HP'])) {
                        $this->HP->CurrentValue = null;
                    }
                    if (!CompareValue($this->Cylinders->DbValue, $row['Cylinders'])) {
                        $this->Cylinders->CurrentValue = null;
                    }
                    if (!CompareValue($this->TransmissionSpeeds->DbValue, $row['Transmission Speeds'])) {
                        $this->TransmissionSpeeds->CurrentValue = null;
                    }
                    if (!CompareValue($this->TransmissAutomatic->DbValue, $row['TransmissAutomatic'])) {
                        $this->TransmissAutomatic->CurrentValue = null;
                    }
                    if (!CompareValue($this->MPGCity->DbValue, $row['MPG City'])) {
                        $this->MPGCity->CurrentValue = null;
                    }
                    if (!CompareValue($this->MPGHighway->DbValue, $row['MPG Highway'])) {
                    ...
                    if (!CompareValue($this->Doors->DbValue, $row['Doors'])) {
                        $this->Doors->CurrentValue = null;
                    }
                    if (!CompareValue($this->Torque->DbValue, $row['Torque'])) {
