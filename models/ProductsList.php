...
class ProductsList extends Products
{
    ...
    // Page object name
    public $PageObjName = "ProductsList";
    ...
    // CSS class/style
    public $CurrentPageName = "productslist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "productsdelete";
        $this->MultiUpdateUrl = "productsupdate";
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->ProductID->AdvancedSearch->toJson(), ","); // Field ProductID
        ...
        $filterList = Concat($filterList, $this->QuantityPerUnit->AdvancedSearch->toJson(), ","); // Field QuantityPerUnit
        $filterList = Concat($filterList, $this->UnitPrice->AdvancedSearch->toJson(), ","); // Field UnitPrice
        $filterList = Concat($filterList, $this->UnitsInStock->AdvancedSearch->toJson(), ","); // Field UnitsInStock
        $filterList = Concat($filterList, $this->UnitsOnOrder->AdvancedSearch->toJson(), ","); // Field UnitsOnOrder
        $filterList = Concat($filterList, $this->ReorderLevel->AdvancedSearch->toJson(), ","); // Field ReorderLevel
        $filterList = Concat($filterList, $this->Discontinued->AdvancedSearch->toJson(), ","); // Field Discontinued
        $filterList = Concat($filterList, $this->EAN13->AdvancedSearch->toJson(), ","); // Field EAN13
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fproductssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        $this->QuantityPerUnit->AdvancedSearch->SearchValue = @$filter["x_QuantityPerUnit"];
        $this->QuantityPerUnit->AdvancedSearch->SearchOperator = @$filter["z_QuantityPerUnit"];
        $this->QuantityPerUnit->AdvancedSearch->SearchCondition = @$filter["v_QuantityPerUnit"];
        $this->QuantityPerUnit->AdvancedSearch->SearchValue2 = @$filter["y_QuantityPerUnit"];
        $this->QuantityPerUnit->AdvancedSearch->SearchOperator2 = @$filter["w_QuantityPerUnit"];
        $this->QuantityPerUnit->AdvancedSearch->save();

        // Field UnitPrice
        $this->UnitPrice->AdvancedSearch->SearchValue = @$filter["x_UnitPrice"];
        $this->UnitPrice->AdvancedSearch->SearchOperator = @$filter["z_UnitPrice"];
        $this->UnitPrice->AdvancedSearch->SearchCondition = @$filter["v_UnitPrice"];
        $this->UnitPrice->AdvancedSearch->SearchValue2 = @$filter["y_UnitPrice"];
        $this->UnitPrice->AdvancedSearch->SearchOperator2 = @$filter["w_UnitPrice"];
        $this->UnitPrice->AdvancedSearch->save();

        // Field UnitsInStock
        $this->UnitsInStock->AdvancedSearch->SearchValue = @$filter["x_UnitsInStock"];
        $this->UnitsInStock->AdvancedSearch->SearchOperator = @$filter["z_UnitsInStock"];
        $this->UnitsInStock->AdvancedSearch->SearchCondition = @$filter["v_UnitsInStock"];
        $this->UnitsInStock->AdvancedSearch->SearchValue2 = @$filter["y_UnitsInStock"];
        $this->UnitsInStock->AdvancedSearch->SearchOperator2 = @$filter["w_UnitsInStock"];
        $this->UnitsInStock->AdvancedSearch->save();

        // Field UnitsOnOrder
        $this->UnitsOnOrder->AdvancedSearch->SearchValue = @$filter["x_UnitsOnOrder"];
        $this->UnitsOnOrder->AdvancedSearch->SearchOperator = @$filter["z_UnitsOnOrder"];
        $this->UnitsOnOrder->AdvancedSearch->SearchCondition = @$filter["v_UnitsOnOrder"];
        $this->UnitsOnOrder->AdvancedSearch->SearchValue2 = @$filter["y_UnitsOnOrder"];
        $this->UnitsOnOrder->AdvancedSearch->SearchOperator2 = @$filter["w_UnitsOnOrder"];
        $this->UnitsOnOrder->AdvancedSearch->save();
        ...
        // Field Discontinued
        $this->Discontinued->AdvancedSearch->SearchValue = @$filter["x_Discontinued"];
        $this->Discontinued->AdvancedSearch->SearchOperator = @$filter["z_Discontinued"];
        $this->Discontinued->AdvancedSearch->SearchCondition = @$filter["v_Discontinued"];
        $this->Discontinued->AdvancedSearch->SearchValue2 = @$filter["y_Discontinued"];
        $this->Discontinued->AdvancedSearch->SearchOperator2 = @$filter["w_Discontinued"];
        $this->Discontinued->AdvancedSearch->save();

        // Field EAN13
        $this->EAN13->AdvancedSearch->SearchValue = @$filter["x_EAN13"];
        $this->EAN13->AdvancedSearch->SearchOperator = @$filter["z_EAN13"];
        $this->EAN13->AdvancedSearch->SearchCondition = @$filter["v_EAN13"];
        $this->EAN13->AdvancedSearch->SearchValue2 = @$filter["y_EAN13"];
        $this->EAN13->AdvancedSearch->SearchOperator2 = @$filter["w_EAN13"];
        $this->EAN13->AdvancedSearch->save();
    ...
    public function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->ProductID, $default, false); // ProductID
        $this->buildSearchSql($where, $this->ProductName, $default, true); // ProductName
        $this->buildSearchSql($where, $this->SupplierID, $default, false); // SupplierID
        $this->buildSearchSql($where, $this->CategoryID, $default, false); // CategoryID
        $this->buildSearchSql($where, $this->QuantityPerUnit, $default, false); // QuantityPerUnit
        $this->buildSearchSql($where, $this->UnitPrice, $default, false); // UnitPrice
        $this->buildSearchSql($where, $this->UnitsInStock, $default, false); // UnitsInStock
        $this->buildSearchSql($where, $this->UnitsOnOrder, $default, false); // UnitsOnOrder
        $this->buildSearchSql($where, $this->ReorderLevel, $default, false); // ReorderLevel
        $this->buildSearchSql($where, $this->Discontinued, $default, false); // Discontinued
        $this->buildSearchSql($where, $this->EAN13, $default, false); // EAN13
        ...
        if (!$default && $this->Command == "search") {
            $this->ProductID->AdvancedSearch->save(); // ProductID
            $this->ProductName->AdvancedSearch->save(); // ProductName
            $this->SupplierID->AdvancedSearch->save(); // SupplierID
            $this->CategoryID->AdvancedSearch->save(); // CategoryID
            $this->QuantityPerUnit->AdvancedSearch->save(); // QuantityPerUnit
            $this->UnitPrice->AdvancedSearch->save(); // UnitPrice
            $this->UnitsInStock->AdvancedSearch->save(); // UnitsInStock
            $this->UnitsOnOrder->AdvancedSearch->save(); // UnitsOnOrder
            $this->ReorderLevel->AdvancedSearch->save(); // ReorderLevel
            $this->Discontinued->AdvancedSearch->save(); // Discontinued
            $this->EAN13->AdvancedSearch->save(); // EAN13
    ...
    public function showFilterList()
    {
        ...
        // Field ProductID
        $filter = $this->queryBuilderWhere("ProductID");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->ProductID, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->ProductID->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field ProductName
        $filter = $this->queryBuilderWhere("ProductName");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->ProductName, false, true);
        }
        if ($filter != "") {
        ...
        // Field CategoryID
        $filter = $this->queryBuilderWhere("CategoryID");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->CategoryID, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->CategoryID->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field QuantityPerUnit
        $filter = $this->queryBuilderWhere("QuantityPerUnit");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->QuantityPerUnit, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->QuantityPerUnit->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field UnitPrice
        $filter = $this->queryBuilderWhere("UnitPrice");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->UnitPrice, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->UnitPrice->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field UnitsInStock
        $filter = $this->queryBuilderWhere("UnitsInStock");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->UnitsInStock, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->UnitsInStock->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field UnitsOnOrder
        $filter = $this->queryBuilderWhere("UnitsOnOrder");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->UnitsOnOrder, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->UnitsOnOrder->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field ReorderLevel
        $filter = $this->queryBuilderWhere("ReorderLevel");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->ReorderLevel, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->ReorderLevel->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field Discontinued
        $filter = $this->queryBuilderWhere("Discontinued");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->Discontinued, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->Discontinued->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field EAN13
        $filter = $this->queryBuilderWhere("EAN13");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->EAN13, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->EAN13->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }
        if ($this->BasicSearch->Keyword != "") {
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->ProductName;
        $searchFlds[] = &$this->QuantityPerUnit;
        $searchFlds[] = &$this->Discontinued;
        $searchFlds[] = &$this->EAN13;
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->ProductID->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->CategoryID->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->QuantityPerUnit->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->UnitPrice->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->UnitsInStock->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->UnitsOnOrder->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->ReorderLevel->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->Discontinued->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->EAN13->AdvancedSearch->issetSession()) {
            return true;
        }
        return false;
    }
    ...
    {
        $this->ProductID->AdvancedSearch->unsetSession();
        $this->ProductName->AdvancedSearch->unsetSession();
        $this->SupplierID->AdvancedSearch->unsetSession();
        $this->CategoryID->AdvancedSearch->unsetSession();
        $this->QuantityPerUnit->AdvancedSearch->unsetSession();
        $this->UnitPrice->AdvancedSearch->unsetSession();
        $this->UnitsInStock->AdvancedSearch->unsetSession();
        $this->UnitsOnOrder->AdvancedSearch->unsetSession();
        $this->ReorderLevel->AdvancedSearch->unsetSession();
        $this->Discontinued->AdvancedSearch->unsetSession();
        $this->EAN13->AdvancedSearch->unsetSession();
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->ProductID); // ProductID
            ...
            $this->updateSort($this->QuantityPerUnit); // QuantityPerUnit
            $this->updateSort($this->UnitPrice); // UnitPrice
            $this->updateSort($this->UnitsInStock); // UnitsInStock
            $this->updateSort($this->UnitsOnOrder); // UnitsOnOrder
            $this->updateSort($this->ReorderLevel); // ReorderLevel
            $this->updateSort($this->Discontinued); // Discontinued
            $this->updateSort($this->EAN13); // EAN13
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->QuantityPerUnit->setSort("");
                $this->UnitPrice->setSort("");
                $this->UnitsInStock->setSort("");
                $this->UnitsOnOrder->setSort("");
                $this->ReorderLevel->setSort("");
                $this->Discontinued->setSort("");
                $this->EAN13->setSort("");
            }
    ...
    public function renderListOptions()
    {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fproductslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fproductslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->ProductID->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "ProductID");
            $this->createColumnOption($option, "ProductName");
            $this->createColumnOption($option, "SupplierID");
            $this->createColumnOption($option, "CategoryID");
            $this->createColumnOption($option, "QuantityPerUnit");
            $this->createColumnOption($option, "UnitPrice");
            $this->createColumnOption($option, "UnitsInStock");
            $this->createColumnOption($option, "UnitsOnOrder");
            $this->createColumnOption($option, "ReorderLevel");
            $this->createColumnOption($option, "Discontinued");
            $this->createColumnOption($option, "EAN13");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fproductssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fproductssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fproductslist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_products", "data-rowtype" => RowType::ADD]);
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->ProductID->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->ProductID->AdvancedSearch->SearchValue != "" || $this->ProductID->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->CategoryID->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->CategoryID->AdvancedSearch->SearchValue != "" || $this->CategoryID->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->QuantityPerUnit->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->QuantityPerUnit->AdvancedSearch->SearchValue != "" || $this->QuantityPerUnit->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->UnitPrice->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->UnitPrice->AdvancedSearch->SearchValue != "" || $this->UnitPrice->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->UnitsInStock->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->UnitsInStock->AdvancedSearch->SearchValue != "" || $this->UnitsInStock->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->UnitsOnOrder->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->UnitsOnOrder->AdvancedSearch->SearchValue != "" || $this->UnitsOnOrder->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->ReorderLevel->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->ReorderLevel->AdvancedSearch->SearchValue != "" || $this->ReorderLevel->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->Discontinued->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Discontinued->AdvancedSearch->SearchValue != "" || $this->Discontinued->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->EAN13->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->EAN13->AdvancedSearch->SearchValue != "" || $this->EAN13->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        return $hasValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // ProductName
            if ($this->ProductName->UseFilter && !EmptyValue($this->ProductName->AdvancedSearch->SearchValue)) {
                if (is_array($this->ProductName->AdvancedSearch->SearchValue)) {
                    $this->ProductName->AdvancedSearch->SearchValue = implode(Config("FILTER_OPTION_SEPARATOR"), $this->ProductName->AdvancedSearch->SearchValue);
                }
                $this->ProductName->EditValue = explode(Config("FILTER_OPTION_SEPARATOR"), $this->ProductName->AdvancedSearch->SearchValue);
            }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fproductslist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fproductssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
        ...
        if ($this->ModalSearch && !IsMobile()) {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch", true) . "\" data-table=\"products\" data-caption=\"" . $Language->phrase("AdvancedSearch", true) . "\" data-ew-action=\"modal\" data-url=\"productssearch\" data-btn=\"SearchBtn\">" . $Language->phrase("AdvancedSearch", false) . "</a>";
        } else {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch", true) . "\" data-caption=\"" . $Language->phrase("AdvancedSearch", true) . "\" href=\"productssearch\">" . $Language->phrase("AdvancedSearch", false) . "</a>";
        }
        $item->Visible = true;
    ...
    */
    public function exportData($doc)
    {
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "categories") {
            $categories = new CategoriesList();
            $rsmaster = $categories->loadRs($this->DbMasterFilter); // Load master record
            if ($rsmaster) {
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->setTable($categories);
