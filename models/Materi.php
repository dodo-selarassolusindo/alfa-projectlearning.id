...
class Materi extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Tipe
        $this->Tipe = new DbField(
            $this, // Table
            'x_Tipe', // Variable name
            'Tipe', // Name
            '`Tipe`', // Expression
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("materilist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "materiview" => $Language->phrase("View"),
            "materiedit" => $Language->phrase("Edit"),
            "materiadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MateriView",
            Config("API_ADD_ACTION") => "MateriAdd",
            Config("API_EDIT_ACTION") => "MateriEdit",
            Config("API_DELETE_ACTION") => "MateriDelete",
            Config("API_LIST_ACTION") => "MateriList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("materiview", $parm);
        } else {
            $url = $this->keyUrl("materiview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("materiedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("materilist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("materiadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("materilist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("materidelete", $parm);
        }
    }
