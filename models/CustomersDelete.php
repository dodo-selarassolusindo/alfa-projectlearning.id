 ...
 * Page class
 */
class CustomersDelete extends Customers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CustomersDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "customersdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("customerslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("customerslist"); // Return to list
                return;
            }
        }
