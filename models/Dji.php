...
class Dji extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Date = new DbField(
            ...
            'Date', // Name
            '`Date`', // Expression
            CastDateFieldForLike("`Date`", 0, "demo2"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
        ...
        $this->Date->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['Date'] = &$this->Date;

        // Open
        $this->Open = new DbField(
            $this, // Table
            'x_Open', // Variable name
            'Open', // Name
            '`Open`', // Expression
            '`Open`', // Basic search expression
            5, // Type
            22, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Open`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Open->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['Open'] = &$this->Open;

        // High
        $this->High = new DbField(
            $this, // Table
            'x_High', // Variable name
            'High', // Name
            '`High`', // Expression
            '`High`', // Basic search expression
            5, // Type
            22, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`High`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->High->InputTextType = "text";
        $this->High->Raw = true;
        $this->High->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->High->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['High'] = &$this->High;

        // Low
        $this->Low = new DbField(
            $this, // Table
            'x_Low', // Variable name
            'Low', // Name
            '`Low`', // Expression
            '`Low`', // Basic search expression
            5, // Type
            22, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Low`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Low->InputTextType = "text";
        $this->Low->Raw = true;
        $this->Low->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->Low->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['Low'] = &$this->Low;

        // Close
        $this->Close = new DbField(
            $this, // Table
            'x_Close', // Variable name
            'Close', // Name
            '`Close`', // Expression
            '`Close`', // Basic search expression
            5, // Type
            22, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Close`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Close->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['Close'] = &$this->Close;

        // Volume
        $this->Volume = new DbField(
            $this, // Table
            'x_Volume', // Variable name
            'Volume', // Name
            '`Volume`', // Expression
            '`Volume`', // Basic search expression
            5, // Type
            22, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Volume`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Volume->InputTextType = "text";
        $this->Volume->Raw = true;
        $this->Volume->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->Volume->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['Volume'] = &$this->Volume;

        // Adj Close
        $this->AdjClose = new DbField(
            $this, // Table
            'x_AdjClose', // Variable name
            'Adj Close', // Name
            '`Adj Close`', // Expression
            '`Adj Close`', // Basic search expression
            5, // Type
            22, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Adj Close`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->AdjClose->InputTextType = "text";
        $this->AdjClose->Raw = true;
        $this->AdjClose->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->AdjClose->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['Adj Close'] = &$this->AdjClose;
        ...
        $this->Name = new DbField(
            ...
            'Name', // Name
            '`Name`', // Expression
            CastDateFieldForLike("`Name`", 0, "demo2"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
        ...
        $this->Name->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['Name'] = &$this->Name;

        // Name2
        $this->Name2 = new DbField(
            $this, // Table
            'x_Name2', // Variable name
            'Name2', // Name
            '`Name2`', // Expression
            '`Name2`', // Basic search expression
            200, // Type
            50, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Name2`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Name2->InputTextType = "text";
        $this->Name2->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->AdjClose->DbValue = $row['Adj Close'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("djilist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "djiview" => $Language->phrase("View"),
            "djiedit" => $Language->phrase("Edit"),
            "djiadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DjiView",
            Config("API_ADD_ACTION") => "DjiAdd",
            Config("API_EDIT_ACTION") => "DjiEdit",
            Config("API_DELETE_ACTION") => "DjiDelete",
            Config("API_LIST_ACTION") => "DjiList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("djiview", $parm);
        } else {
            $url = $this->keyUrl("djiview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("djilist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("djilist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("djidelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->Name->EditValue = FormatDateTime($this->Name->CurrentValue, $this->Name->formatPattern());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->AdjClose);
