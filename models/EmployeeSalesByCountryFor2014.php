...
/**
 * Table class for employee_sales_by_country_for_2014
 */
class EmployeeSalesByCountryFor2014 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "employee_sales_by_country_for_2014";
        $this->TableName = 'employee_sales_by_country_for_2014';
        $this->TableType = "VIEW";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "employee_sales_by_country_for_2014";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "employee_sales_by_country_for_2014";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("employeesalesbycountryfor2014list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "employeesalesbycountryfor2014view" => $Language->phrase("View"),
            "employeesalesbycountryfor2014edit" => $Language->phrase("Edit"),
            "employeesalesbycountryfor2014add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "employeesalesbycountryfor2014list";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "EmployeeSalesByCountryFor2014View",
            Config("API_ADD_ACTION") => "EmployeeSalesByCountryFor2014Add",
            Config("API_EDIT_ACTION") => "EmployeeSalesByCountryFor2014Edit",
            Config("API_DELETE_ACTION") => "EmployeeSalesByCountryFor2014Delete",
            Config("API_LIST_ACTION") => "EmployeeSalesByCountryFor2014List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("employeesalesbycountryfor2014view", $parm);
        } else {
            $url = $this->keyUrl("employeesalesbycountryfor2014view", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "employeesalesbycountryfor2014add?" . $parm;
        } else {
            $url = "employeesalesbycountryfor2014add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("employeesalesbycountryfor2014edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("employeesalesbycountryfor2014list", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("employeesalesbycountryfor2014add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("employeesalesbycountryfor2014list", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("employeesalesbycountryfor2014delete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "EmployeeSalesByCountryFor2014List";
    ...
    public function renderListRow()
    {
        ...
        $this->Subtotal->ViewValue = FormatNumber($this->Subtotal->ViewValue, $this->Subtotal->formatPattern());
